...
class M_kel_harga_detail extends CI_Model {

	var $table = 'tbl_marginkelompokdetail';
	var $column_order = array('koders', 'kodeharga', 'umum','member',null); 
	var $column_search = array('koders', 'kodeharga', 'umum','member');
	var $order = array('kodeharga' => 'asc'); 
