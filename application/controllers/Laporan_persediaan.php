          ...
          if (!empty($cek)) {
               if($laporan == 0){
                    ...
                    foreach ($queryx as $qx) {
                         ...
                         $y = "SELECT *, (total_masuk - total_keluar + so) AS saldo, hpp, ((total_masuk + so - total_keluar) * hpp) AS total, 
                         sal_awal_masuk('$cabang', '$tgl_kemarin', '$depo', z.kodebarang)as jeda_total_masuk,
                         sal_awal_keluar('$cabang', '$tgl_kemarin', '$depo', z.kodebarang)as jeda_total_keluar 
                         FROM 
                              ( 
                                   SELECT p.*, (pembelian + move_in + produksi_jadi + retur_beli) AS total_masuk, 
                                   (jual + mutasi_out + retur_jual + produksi_bahan + bhp + expire) AS total_keluar 
                                   FROM 
                                   ( 
                                        SELECT a.kodebarang, a.saldoakhir as saldoakhirnya,
                                        (SELECT namabarang FROM tbl_barang WHERE kodebarang = a.kodebarang) AS namabarang, 
                                        (SELECT satuan1 FROM tbl_barang WHERE kodebarang = a.kodebarang) AS satuan, 
                                        (SELECT hargabelippn FROM tbl_barang WHERE kodebarang = a.kodebarang) AS hpp, 
                                        IFNULL( 
                                             ...
                                             WHERE ht.gudang = '$depo' AND ht.koders = '$cabang' AND ht.terima_date BETWEEN '$dari' AND '$sampai' GROUP BY dt.kodebarang 
                                             ) AS beli 
                                        ...
                                        IFNULL( 
                                             ...
                                             WHERE hm.dari = '$depo' AND hm.koders = '$cabang' AND hm.movedate BETWEEN '$dari' AND '$sampai' GROUP BY dm.kodebarang 
                                             ) AS move_i 
                                        ...
                                        IFNULL( 
                                             ...
                                             WHERE gudang = '$depo' AND koders = '$cabang' AND tglproduksi BETWEEN '$dari' AND '$sampai' GROUP BY kodebarang 
                                             ) AS prod_jadi 
                                        ...
                                        IFNULL( 
                                             ...
                                             FROM tbl_aposesuai 
                                             WHERE gudang = '$depo' AND koders = '$cabang' AND tglso BETWEEN '$dari' AND '$sampai' GROUP BY kodebarang 
                                             ) AS so_ 
                                        ...
                                        IFNULL( 
                                             ...
                                             WHERE hr.gudang = '$depo' AND hr.koders = '$cabang' AND hr.retur_date BETWEEN '$dari' AND '$sampai' GROUP BY dr.kodebarang 
                                             ) AS ret 
                                        ...
                                        IFNULL( 
                                             ...
                                             WHERE h.gudang = '$depo' AND h.koders = '$cabang' AND h.tglresep BETWEEN '$dari' AND '$sampai' GROUP BY d.kodebarang 
                                             UNION ALL 
                                        ...
                                        IFNULL( 
                                             ...
                                             FROM tbl_apodmove dm JOIN tbl_apohmove hm ON dm.moveno = hm.moveno 
                                             WHERE hm.ke = '$depo' AND hm.koders = '$cabang' AND hm.movedate BETWEEN '$dari' AND '$sampai' GROUP BY dm.kodebarang 
                                             ) AS move_o 
                                        ...
                                        IFNULL( 
                                             ...
                                             WHERE hm.gudang = '$depo' AND hm.koders = '$cabang' AND hm.tglretur BETWEEN '$dari' AND '$sampai' GROUP BY dm.kodebarang 
                                             ) AS retur_j 
                                        ...
                                        IFNULL( 
                                             ...
                                             AND tbl_apohproduksi.tglproduksi BETWEEN '$dari' AND '$sampai' GROUP BY kodebarang 
                                             ) AS prod_jadi 
                                        ...
                                        IFNULL( 
                                             ...
                                             AND tbl_apohpakai.tglbhp BETWEEN '$dari' AND '$sampai' GROUP BY kodebarang 
                                             ) AS prod_jadi 
                                        ...
                                        IFNULL( 
                                             ...
                                             WHERE hm.gudang = '$depo' AND hm.koders = '$cabang' AND hm.tgl_ed BETWEEN '$dari' AND '$sampai' GROUP BY dm.kodebarang 
                                             ) AS expi 
                                        WHERE expi.kodebarang=a.kodebarang ) ,0) AS expire 
                                   FROM tbl_barangstock a WHERE a.gudang = '$depo' AND a.koders = '$cabang' AND a.kodebarang != ''
                              ) p ) z
                              ORDER BY kodebarang
                         ";
                         $query = $this->db->query($y)->result();
