	...
	public function cetak2()
	{
		...
		if (!empty($cek)) {
			...
			$chari .=   "<table style=\"border-collapse:collapse;font-family: tahoma; font-size:12px\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
							<thead>
                              <tr>
                                   <th bgcolor=\"#cccccc\" width=\"15%\">No. Bukti</th>
                                   <th bgcolor=\"#cccccc\" width=\"10%\">Tanggal</th>
                                   <th bgcolor=\"#cccccc\" width=\"10%\">Jam</th>
                                   ...
                                   <th bgcolor=\"#cccccc\" width=\"10%\">Saldo Akhir</th>
			...
			$jamnya = $stok_awal->jam;
			$coba            = $this->M_KartuStock->cekstok_farmasi($cabang, $barang, $gudang, $_tgl1, $_tgl2, $jamnya);
			if ($coba) {
				...
				$saldo = $stok_awal->saldoawal;
			} else {
				$_tanggalawal    = $dari;
				$saldo           = $stok_awal->saldoawal + 0;
				$jam          = date("H:i:s");
			}
			$chari .= " <tr>
							<td width=\"20%\">SALDO</td>
							<td width=\"10%\">" . date("d-m-Y", strtotime($_tanggalawal)) . "</td>
							<td width=\"5%\">" . $jamnya . "</td>
			...
			foreach ($queryx as $db) {
				...
				$chari .= "	<tr>
					...
					<td width=\"5%\">" . date("H:i:s", strtotime($db->jam)) . "</td>
			...
			switch ($cekk) {
				case 0;
					echo ("<title>KARTU STOK CABANG $datars->kota</title>");
					echo ($chari);
					break;

				case 1;
					$this->M_cetak->mpdf('L', 'A4', $judul, $chari, 'KARTU-STOCK.PDF', 10, 10, 10, 2);
					break;
				case 2;
