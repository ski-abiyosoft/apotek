...
/**
 * This is the extended class of FPDF, here we add some feature 
 * like barcode and multiline support.
 * 
 */
...
class FPDF_extended extends FPDF
{
    ...
    public function Row($data, bool $fill = false)
    {
    ...
    +=============================================================+
    +                                                             +
    + Fungsi tambahan untuk mencetak barcode                      +
    +                                                             +
    +=============================================================+
     */
    ...
    {
        $this->T128[] = array(2, 1, 2, 2, 2, 2);           //0 : [ ]               // Komposisi Karakter
