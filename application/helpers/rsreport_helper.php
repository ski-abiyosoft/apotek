...
{ 
    if ($this->header == 1){
        ...
        $namars     = "RS MATA M77";
        $alamatrs   = "Jalan Sei Mencirim No.77, Kecamatan Medan Baru\nKota Medan - Sumatera Utara";
        $phoners    = "+6282366644177";

        $this->image('./assets/img/rskm77.png',10,10,22);
        $this->cell(25);
        $this->SetFont('Arial','B',12);
        $this->cell(0,5,$namars,0,1); 
        $this->cell(25);
        $this->SetFont('Arial','',10);
        $this->MultiCell(0,4,$alamatrs,0,1);     
        $this->cell(25);
        $this->SetFont('Arial','',10);
        $this->cell(0,4,$phoners,0,1);     
        $this->cell(25);
        $this->SetTextColor(0);  
