...
<head>
    ...
    <title>REKAP PENERIMAAN BARANG BY SUPLIER+ITEM BARANG</title>
</head>
...
<body>
    ...
    <table style="border-collapse:collapse;font-family: Century Gothic; font-size:12px; color:#000;" width="100%"
        ...
        <thead>
            ...
            <tr>
                <td colspan="21" style="text-align:center; font-size:22px; border-bottom: none;color:#120292;"><b>03 REKAP
                        PENERIMAAN BARANG BY SUPLIER+ITEM BARANG</b></td>
            </tr>
            <tr>
