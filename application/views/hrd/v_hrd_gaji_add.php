			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="note note-success">
						<p>
                         Modul ini berfungsi untuk Proses Perhitungan Gaji.<br>
										...
										<form id="frmtutupbuku" class="form-horizontal form-bordered1" method="post"  >
											...
											<div class="form-actions fluid">
												<div class="col-md-offset-3 col-md-9">
													<button type="button" class="btn blue" onclick="save()" id="btnproses">Hitung Gaji</button>
...
function save(){
	 ...
	 $("#loader").hide();
		...
		if(tahun.length > 0 && bulan.length > 0 && tanggal.length > 0) {
            ...
            $.ajax({
                type: "POST",                
				url:'<?php echo base_url('hrd_gaji/hitunggaji')?>',	
                data: qry,
