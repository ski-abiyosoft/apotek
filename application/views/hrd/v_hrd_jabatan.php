    ...
    <link href="<?php echo base_url('assets/bootstrap-datepicker/css/bootstrap-datepicker3.min.css')?>" rel="stylesheet">
			...
			<div class="row">
				<div class="col-md-12">
					<h3 class="page-title">
					  Payroll <small>Data Jabatan</small>
					</h3>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('hrd_jabatan/ajax_list')?>",
            "type": "POST"
        },
...
function edit_bank(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('hrd_jabatan/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('hrd_jabatan/ajax_add')?>";
    } else {
        url = "<?php echo site_url('hrd_jabatan/ajax_update')?>";
    }
...
function delete_bank(id)
{
    if(confirm('Yakin data Jabatan dengan kode '+id+' ini akan dihapus ?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('hrd_jabatan/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function cetaklap(str) {
  ...
  xhttp.open("GET", "<?php echo base_url(); ?>hrd_jabatan/cetak/"+str, true);  
  xhttp.send();
}
...
<script>
	$(document).ready(function() {
		...
		$("#simkeureport").html('<iframe src="<?php echo base_url();?>hrd_jabatan/cetak/'+no_daftar+'" frameborder="no" width="100%" height="420"></iframe>');
		});	
	});
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nama" placeholder="Nama Jabatan" class="form-control" maxlength="30" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
