                ...
                <div class="tabbable tabbable-custom tabbable-full-width">
                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="nomor_transaksi" name="nomor_transaksi"
                                                class="form-control rightJustified" value="<?php echo $notukar;?>"
                                                readonly>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input id="tanggal_buat" name="tanggal_buat" class="form-control rightJustified"
                                                type="date" value="<?php echo $tanggal;?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <textarea id="catatan" name="catatan" class="form-control" rows="4" cols="50"><?php echo $keterangan; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <!-- <textarea id="rekening" name="rekening" class="form-control" rows="4" cols="50"><?php echo $norekening; ?></textarea> -->
                                            <select id="rekening" name="rekening" class="form-control select2_el_rekening_vendor"
                                                data-placeholder="Pilih...">
                                                <option value="<?php echo $norekening; ?>" checked><?php echo $keterangan_rekening; ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table class="table table-striped table-hover table-bordered" id="">
                            ...
                            <tbody id="daftar_tagihan_pilihan">
                        <!-- <?php
                            if($detail != ''){
                                foreach($detail as $value){
                                
                        ?>  
                                <td style='text-align: center'><?php echo $value->terima_no; ?></td>
                                <td style='text-align: center'><?php echo $value->invoice_no; ?></td>
                                <td style='text-align: center'><?php echo $value->tglinvoice; ?></td>
                                <td style='text-align: center'><?php echo $value->duedate; ?></td>
                                <td style='text-align: center'><?php echo number_format($value->totaltagihan,0,'.',','); ?></td>
                                <td style='text-align: center'><a href='#' onclick="hapus_tagihan('<?php echo $value->terima_no; ?>')">Hapus</a></td>
                                <input type='hidden' id='terima_no[]' name='terima_no[]' value='<?php echo $value->terima_no; ?>'>
                                <input type='hidden' id='invoice_no[]' name='invoice_no[]' value='"<?php echo $value->invoice_no; ?>'>
                                <input type='hidden' id='tglinvoice[]' name='tglinvoice[]' value='"<?php echo $value->tglinvoice; ?>'>
                                <input type='hidden' id='duedate[]' name='duedate[]' value='"<?php echo $value->duedate; ?>'>
                                <input type='hidden' id='totaltagihan[]' name='totaltagihan[]' value='"<?php echo number_format($value->totaltagihan,0,'.',','); ?>'>
                        <?php
                                }
                            }
                        ?> -->
                    ...
                    <div class="row form-actions">
                        <div class="col-xs-8">
                            ...
                            <!-- onclick="save()" -->
                                ...
                                <input type="hidden" id="id" name="id" class="form-control rightJustified" value="<?php echo $id; ?>">
...
$.ajax({
    url: "<?php echo site_url('hutang_tukarfaktur/getTagihan?vendor=')?>" + vndr,
    type: "GET",
    dataType: "JSON",
...
tagihan_terpilih = JSON.parse('<?php echo json_encode($detail); ?>');

console.log(detail);
console.log(tagihan_terpilih);
// if(detail !== ''){
//     var i = 0;
        ...
        $.ajax({
            ...
            {           
                ...
                $.each(data, function( key, value ) {
                    ...
                    var input_checkbox = '';
                    console.log('vt : ' + value.tukarfaktur + ', '+find3);
                    if(value.tukarfaktur == 0 || find3) {
...
function pilih_tagihan(){
    ...
    if(fdt == '') {
        ...
        dts = $("input[name='terima_no[]']").map(function(){return $(this).val();}).get(); 
        console.log(dts);
...
function save() {
    ...
    if (
        ...
        $.ajax({
            url: '<?php echo site_url('hutang_tukarfaktur/save/2')?>',
            data: $('#frm').serialize(),
            type: 'POST',
            success: function(data) {
                console.log(data);
                ...
                swal({
                    title: "EDIT TUKAR FAKTUR",
                    html: "<p> No. Transaksi   : <b>" + nomor_transaksi + "</b> </p>" +
