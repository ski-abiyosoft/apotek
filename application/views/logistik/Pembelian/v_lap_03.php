     ...
     <table class="table table-striped table-borderd table-hover"style="border-collapse:collapse;font-family: Times New Roman; font-size:12px" width="100%" align="center" border="1" cellspacing="1" cellpadding="3">
          <thead>
               <tr>
                    ...
                    <th bgcolor="#cccccc" align="right">Qty</th>
                    <th bgcolor="#cccccc" align="right">Harga Rata-rata</th>
                    <th bgcolor="#cccccc" align="right">Total</th>
               </tr>
               <tr>
                    <?php foreach($vendorx as $v) : ?>
                    <th colspan="7"><?= $v->vendor_name; ?></th>
                    <?php endforeach; ?>
               </tr>
          </thead>
          <tbody>
