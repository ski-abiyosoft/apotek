          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <input type="text" placeholder="Otomatis" name="nomorbukti" class="form-control" value="Auto" readonly>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <table id="datatable"
              ...
              <thead>
                ...
                <tbody>
                  <tr>
                    <td>
                      <select name="kode[]" id="kode1" class="select2_el_log_baranggud form-control"
                    ...
                    <td>
                      <input name="qty[]" onchange="totalline(1);total()" value="1" id="qty1" type="text"
                    ...
                    <td>
                      <input name="harga[]" id="harga1" type="text" class="form-control rightJustified"
                        onkeypress="return tabE(this,event)">
                    </td>
                    <td>
                      <input name="total[]" id="total1" type="text" class="form-control rightJustified sumtot"
              ...
              <tfoot>
                <tr>
                  ...
                  <td>
                    <input type="text" class="form-control rightJustified" id="vtotal" readonly>
                  </td>
                  <td colspan="2"></td>
                </tr>
              </tfoot>
            ...
            <!-- <div class="row">
                        ...
                        <div class="col-sm-3">
                            <input name="total[]" id="total1" type="text" class="form-control rightJustified sumtot"
                                onkeypress="return tabE(this,event)" value="total1" readonly>
                        </div>
                    </div> -->
        ...
        <div class="row">
          <div class="col-xs-12">
            <div style="padding:20px 0px 0px 0px">
              <button type="button" onclick="save()" class="btn blue" id="savebtn"><i class="fa fa-save"></i>&nbsp;
                Simpan</button>
              <button type="reset" class="btn green" onclick="location.href='/logistik_keluar/entri'"><i
                  class=" fa fa-edit"></i>&nbsp; Reset</button>
...
function tambah() {
  ...
  td1.innerHTML = '<select name="kode[]" id="kode' + idrow +
    '" class="select2_el_log_baranggud form-control" onchange="showbarangname(this.value, ' + idrow + ')"></select>';
  ...
  td4.innerHTML = "<input name='harga[]'  id='harga" + idrow + "' onchange='totalline(" + idrow +
    ")' onkeyup='format_num(this.value)' type='text' class='form-control rightJustified' >";
...
function showbarangname(str, id) {
  ...
  $.ajax({
    url: "<?php echo base_url(); ?>permohonan_log/getinfobarang/?str=" + str + "&gudang_asal=" + gudang_asal,
    type: "GET",
    dataType: "JSON",
...
function total() {
  ...
  // document.getElementById("vtotal").innerHTML = formatCurrency1(tjumlah);
