              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <select id="gudang" name="gudang" class="form-control select2_el_logistik_depo"
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      ...
                      <input id="tanggal" name="tanggal" class="form-control input-medium" type="date"
                        value="<?php echo date('Y-m-d', strtotime($header->po_date)); ?>" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input id="tanggalkirim" name="tanggalkirim" class="form-control input-medium" type="date"
                        value="<?php echo date('Y-m-d', strtotime($header->ship_date)); ?>" />
                    </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      ...
                      <select name="dikirimvia" id="dikirimvia" value="<?= $header->ship_via; ?>" class="form-control">
                        <option <?= $header->ship_via == 'Call' ? 'selected' : ''; ?> value="Call">
                          Call
                        </option>
                        <option <?= $header->ship_via == 'Reff PBF' ? 'selected' : ''; ?> value="Reff PBF">Reff PBF
                        </option>
                        ...
                        <!-- <option <?= $header->ship_via == 'SMS' ? 'selected' : ''; ?>value=" SMS ">
                                                    SMS</option> -->
                        <option <?= $header->ship_via == 'Email' ? 'selected' : ''; ?> value="Email">Email</option>
                      </select>
                    </div>
                  </div>
                </div>
                  ...
                  <table id="datatable"
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <input name="harga[]" onchange="totalline(<?php echo $no; ?>);total()"
          ...
          <div class="row">
            <div class="col-xs-9">
              <div class="wells">
                ...
                <div class="btn-group">
                  <a class="btn red" href="<?php echo base_url('logistik_po') ?>"><i class="fa fa-undo"></i><b> KEMBALI
                    </b></a>
                </div>
...
function save() {
  ...
  if (nomor == "" || total == "0.00" || total == "" || alasan == "") {
    ...
    $.ajax({
      url: "<?php echo site_url('Logistik_po/ajax_add/2?ipo=') ?>" + ipo,
