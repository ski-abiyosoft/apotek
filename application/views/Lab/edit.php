    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>lab/saveBilling" method="POST">
                ...
                <input id="billing-add-nolaborat" type="hidden" value="<?= $row->nolaborat ?>" class="form-control" name="nolaborat" placeholder="" required>
...
<!-- <div class="modal fade" id="tesModalEdit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>lab/updateBilling" method="POST">
                ...
                <input id="billing-edit-nolaborat" type="hidden" value="<?= $row->nolaborat ?>" class="form-control" name="nolaborat" placeholder="" required>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>lab/updateBhp" method="POST">
                ...
                <input id="bhp-edit-nolaborat" type="hidden" value="<?= $row->nolaborat ?>" class="form-control" name="notr" placeholder="" required>
...
<!-- <div class="modal fade" id="bhpModalAdd"> -->
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>lab/saveBhp" method="POST">

                <input id="bhp-koders" type="hidden" value="<?= $this->session->userdata('unit') ?>" class="form-control" name="koders" placeholder="" required>
                <input id="bhp-nolaborat" type="hidden" value="<?= $row->nolaborat ?>" class="form-control" name="notr" placeholder="" required>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?= base_url() ?>lab/updateDataPemeriksaan" method="POST" enctype="multipart/form-data">
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">ENTRY PEMERIKSAAN dan BILLING LABORATORIUM</div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="tgllab" name="tgllab" value="<?= str_replace(' 00:00:00', '', $row->tgllab) ?>" placeholder="" format="YYYY-MM-DD" required>
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <select id="noreg" name="noreg" class="selectpicker" data-live-search="true" data-width="100%" onkeypress="return tabE(this,event)" required>
                                    ...
                                    foreach ($noReg as $value) { ?>
                                        <?php if ($row->noreg == $value->noreg) { ?>
                                            <option value="<?= $value->noreg ?>" selected><?= $value->noreg ?>
                                            </option>
                                        <?php } else { ?>
                            ...
                            <div class="col-sm-9">
                                <select required id="drpengirim" name="drpengirim" class="selectpicker" data-live-search="true" data-width="100%" onkeypress="return tabE(this,event)">
                                    ...
                                    foreach ($dataDokter as $value) { ?>
                                        ...
                                        <?php if ($row->drperiksa == $value->kodokter) { ?>
                                            <option value="<?php echo $value->kodokter ?>" selected>
                                                <?php echo $value->nadokter ?></option>
                                        <?php } else { ?>
                                            <option value="<?= $value->kodokter ?>"><?= $value->nadokter ?></option>
                    ...
                    <!-- <div class="col-md-12">
                        ...
                        <a href="<?= base_url() ?>lab" class="btn btn-warning" style="float: right;margin-right:4px !important"><i class="fa fa-arrow-left"></i>
                            Kembali</a>
                    </div> -->
                </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            where notr='$row->nolaborat' ")->result();
                                            ?>
                                            <?php foreach ($dataBilling as $value) {
                                            ...
                                            ?>
                                                <tr>
                                                    <td>
                                                        <a href="#" class="btn btn-primary btn-sm update_data_bhp" data-kode_barang="<?= $value->kodeobat ?>" data-satuan="<?= $value->satuan ?>" data-qty="<?= $value->qty ?>" data-harga="<?= $value->harga ?>" data-total_harga="<?= $value->totalharga ?>" data-gudang="<?= $value->gudang ?>" data-id="<?= $value->id ?>" data-id_pemeriksaan="<?= $row->id ?>" data-dibebankan="<?= $value->dibebankan ?>" data-toggle="modal" data-target="#bhpModalEdit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                        <a href="<?= base_url() ?>lab/delDataBhp/<?= $value->id ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                    </td>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="messages">
                                ...
                                $rilis = ($dataHlab->rilis) ? true : false;
                                ?>
                                    <input type="hidden" value="<?= $row->id ?>" name="id_pemeriksaan">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Tanggal Sampel Di Ambil</label>
                                            <div class="d-flex">
                                                <input type="hidden" name="nolaborat" value="<?= $row->nolaborat ?>">
                                                <input type="date" name="tanggal_sampel_diambil" min="2018-06-07" class="form-control" value="<?= str_replace(' 00:00:00', '', $dataHlab->tglsampel) ?>" id="hasil-tanggal-sampel-diambil" placeholder="" format="YYYY-MM-DD">
                                                <input type="time" name="jam_sampel_diambil" class="form-control" value="<?= trim($dataHlab->jamsampel) ?>" id="hasil-jam-sampel-diambil" placeholder="" step="1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex">
                                                <input type="date" class="form-control" min="2018-06-07" value="<?= str_replace(' 00:00:00', '', $dataHlab->tglselesai) ?>" name="tanggal_selesai_periksa" id="hasil-jam-selesai-periksa" placeholder="">
                                                <input type="time" name="jam_selesai_periksa" class="form-control" value="<?= trim($dataHlab->jamsampel) ?>" id="hasil-jam-selesai-periksa" placeholder="" step="1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="oleh_petugas" class="form-control" id="hasil-oleh-petugas" placeholder="">
                                                ...
                                                foreach ($petugas as $value) :
                                                ?>
                                                    <option value="<?= $value->nokk ?>" <?= $dataHlab->sampeloleh == $value->nokk ? 'selected' : '' ?>> <?= $value->namapetugas ?></option>
                                                <?php
                                                endforeach;
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group m-0">
                                            ...
                                            <label class="form-check-label d-flex  " for="exampleCheck1">
                                                <input type="checkbox" class="form-check-input" id="hasil-final-oleh" name="check_final_oleh" checked=<?= $rilis ?>>
                                                Final Oleh
                                            </label>
                                    ...
                                    <div class="col-lg-12 mt-4">
                                        <div class="d-flex justify-content-end">
                                            <button type="button" class="btn btn-primary" id="hasil-btn-proses-hasil" data-jenis_kelamin="<?= $row->jkel ?>" data-nolaborat="<?= $row->nolaborat ?>" style="margin-bottom: 10px;">
                                                <i class="fa fa-plus" aria-hidden="true"></i> Proses
                                                Hasil
                                            </button>
                                        </div>
                                        <table class="table table-bordered" id="dynamic_field">
                                            ...
                                            <?php 
                                                $tbl_hasillabnew = $this->db->query("SELECT * from tbl_dhasillabnew where nolaborat='$row->nolaborat'")->result();
                                            ?>

                                            <?php if (count($tbl_hasillabnew) > 0) { ?>
                                                <tbody class="hasil-list-pemeriksaan" id="hasil-list-pemeriksaan">
                                                    <?php foreach ($tbl_hasillabnew as $item) : ?>
                                                    <tr>
                                    ...
                                    <?php
                                    $tbl_notes = $this->db->query("SELECT * from tbl_hlabnotes where nolaborat='$row->nolaborat'")->row();
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mt-sm-2 mt-md-2">
                                            <div class="d-flex justify-content-between mt-2" style="margin-top:8px">
                                                ...
                                                <h6>File hasil dari faskes lain( Pemeriksaan Luar )</h6>
                                            ...
                                            <table class="table table-bordered" id="dynamic_field">
                                                ...
                                                <?php 
                                                    $hasil_lab_file = $this->db->query("SELECT * FROM tbl_dhasilfile WHERE nolaborat='$row->nolaborat'")->result();
                                                ?>
                                                <?php if ( count($hasil_lab_file) > 0) { ?>
                                                    <tbody id="berkas-hasil">
                                                        <?php foreach ($hasil_lab_file as $lab_file) :?>
                                                            <tr id="berkas-<?= $lab_file->id ?>">
                                                                <td><textarea class="form-control" name="keterangan_berkas-<?= $lab_file->id ?>" type="text" resizable><?= $lab_file->keteranganfile ?></textarea></td>
                                                                <td>
                                                                    <input type="file" onchange="loadfile(event, id)" name="file_berkas-<?= $lab_file->id ?>" value="<?= base_url($lab_file->lokasifile)  ?>">
                                                                    <input type="hidden" name="old_file-<?= $lab_file->id ?>" value="<?= $lab_file->namafile ?>">
                                                                </td>
                                                                <td><a target="__blank" href="<?= base_url($lab_file->lokasifile) ?>" id="view_berkas-<?= $lab_file->id  ?>">lihat file</a></td>
                                                                <td><button type="button" class="btn btn-danger" onclick="hapusBerkasAjax(`<?= $lab_file->id ?>`, `<?= $lab_file->nolaborat ?>`)" ><i class="fa fa-trash"></i></button></td>
                                                            </tr>
                                                        <?php endforeach;?>
                                                    </tbody>
                                                <?php } else {?>
...
<script>
    $('#noreg').change(function() {
        ...
        $('#namapas').val('Loading...')
        $.ajax({
            url: '<?php echo base_url('lab/pasien_daftar') ?>',
            type: 'POST',
            dataType: "JSON",
            data: {
                noreg: noreg
...
<script>
    ...
    $('#billing-edit-citorp, #billing-edit-qty').on('keyup mouseup', function() {
        console.log('trigger edit qty and citorp')
...
>>>>>>> master
    ...
    function getListPemeriksaan() {
        let jenis_kelamin = $('#hasil-btn-proses-hasil').data('jenis_kelamin');
        let nolaborat = $('#hasil-btn-proses-hasil').data('nolaborat');
        let data = {
            jenis_kelamin,
            nolaborat
        };
