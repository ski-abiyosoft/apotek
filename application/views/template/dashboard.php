        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-12">
                  <div class="table-responsive">
                    ...
                    <table id="datatable_agama" class="table table-striped table-hover table-bordered master-table"
                      width="100%">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align: right; background-color: <?= $bgcolor; ?>; <?= $color; ?>;">
                            <?= number_format($a->jumlah); ?></td>
                        </tr>
                        <?php $no++;
												endforeach; ?>
                      </tbody>
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_agama" onclick="unduh(1)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-12">
                  <div class="table-responsive">
                    ...
                    <table id="datatable_jeniskelamin"
                      class="table table-striped table-hover table-bordered master-table" width="100%">
                      <thead>
                        <tr>
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_jeniskelamin" onclick="unduh(2)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-12">
                  <div class="table-responsive">
                    ...
                    <table id="datatable_pendidikan" class="table table-striped table-hover table-bordered master-table"
                      width="100%">
                      <thead>
                        <tr>
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_pendidikan" onclick="unduh(3)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_pekerjaan" onclick="unduh(4)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_status" onclick="unduh(5)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_carabayar" onclick="unduh(6)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_poli" onclick="unduh(7)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_dokter" onclick="unduh(8)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-12">
                  <div class="table-responsive">
                    ...
                    <table id="datatable_wilayahkecamatan" class="table table-striped table-hover table-bordered"
                      width="100%">
                      <thead>
                        <tr>
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_wilayahkecamatan" onclick="unduh(9)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-12">
                  <div class="table-responsive">
                    ...
                    <table id="datatable_penyakit10" class="table table-striped table-hover table-bordered master-table"
                      width="100%">
                      <thead>
                        <tr>
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_penyakit10" onclick="unduh_p(1)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-12">
                  <div class="table-responsive">
                    ...
                    <table id="datatable_tindakan" class="table table-striped table-hover table-bordered master-table"
                      width="100%">
                      <thead>
                        <tr>
                          <th style="text-align: center;" width="5%">No</th>
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_tindakan" onclick="unduh_p(2)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-12">
                  <div class="table-responsive">
                    ...
                    <table id="datatable_statistik" class="table table-striped table-hover table-bordered master-table"
                      width="100%">
                      <thead>
                        <tr>
                          <th style="text-align: center;" width="5%">No</th>
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn green" type="button" id="download_statistik" onclick="unduh_p(3)"><i
                      class="fa fa-download"></i> Unduh Excel</button>
                </div>
              </div>
            </div>
