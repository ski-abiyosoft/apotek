...
<link href="<?php echo base_url();?>assets/css/style-metronic2.css" rel="stylesheet" type="text/css"/>
...
<style>
   ...
   */
   ...
   .footer-custom{
      background-image: -webkit-gradient(linear, left top, right top, from(#000000), to(#000000)); color: white;
    }

	.voucher-status {padding:5px;border-radius:100px !important}
	.voucher-status .success {background:#198754 !important}
	.voucher-status .primary {background:#0d6efd !important}
	.voucher-status .danger {background:#dc3545 !important}
	.voucher-status .warning {background:#fd7e14 !important}
	.voucher-status .info {background:#fd7e14 !important}
