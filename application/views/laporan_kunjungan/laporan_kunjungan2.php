        ...
        <div class="portlet">
            ...
            <div class="portlet-body">
                <div class="table-toolbar" style="display: flex;justify-content: space-between;">
                    ...
                    <form id="form-filter" action="<?php echo base_url(); ?>laporan_kunjungan/filter2" method="POST">
                        <div class="btn-group">
                            <div class="btn-group" style="display:flex;">
                                <div style='padding:8px;' >Berdasarkan:</div>
                                <select type="text" class="form-control" id="jenis_kunjungan" name="jenis_kunjungan" required onchange="x()">
                    ...
                    <div class="btn-group" style="float:left;">
                        <a href="<?php echo base_url()."laporan_kunjungan/export2/1?jenis_kunjungan=".$jenis_kunjungan."&startdate=".$startdate."&enddate=".$enddate; ?>" class="btn btn-danger">Print</i></a>
                        <a href="<?php echo base_url()."laporan_kunjungan/export2/2?jenis_kunjungan=".$jenis_kunjungan."&startdate=".$startdate."&enddate=".$enddate; ?>"
                ...
                <div class="table-responsive">
                    ...
                    <tbody id="dataPiutang">
                        <?php         
                            ...
                            $no= 1; foreach ($keu as $k) : ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            <td><?php echo $k->rekmed;?></td>
                            <td><?php echo $k->koders;?></td>
                            <td><?php echo $k->namapas;?></td>
                            <td><?php echo $k->jkel;?></td>
                            <td><?php echo date('d-m-Y',strtotime($k->tgllahir));?></td>
                            <td><?php echo $k->umur;?></td>
                            <td><?php echo $k->alamat;?></td>
                            <td><?php echo $k->telp;?></td>
                            <td><?php echo wordwrap($k->konsultasi_tindakan, 50,"<br>\n"); ?></td>
                            <td><?php echo wordwrap($k->nadokter, 50,"<br>\n"); ?></td>
                            <td>-</td>
                            <td><?php echo $k->tgl_kunjungan_pertama; ?></td>
                            <td><?php echo $k->tgl_kunjungan_terakhir; ?></td>
                            <td><?php echo number_format($k->frekuensi,2,'.',','); ?></td>
                            <td><?php echo number_format($k->nilai_pembelanjaan,2,'.',','); ?></td>
                        </tr>
                        <?php endforeach; ?>
            ...
            var oTable = $('#keuangan-keluar-list').dataTable({
                ...
                "fnFooterCallback": function(nRow, aaData, iStart, iEnd, aiDisplay) {
                    ...
                    for (var i = 0; i < aaData.length; i++) {
                        iTotal += aaData[i][14] * 1;
                        iTotal1 += aaData[i][15] * 1;
                    }
