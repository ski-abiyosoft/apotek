    ...
    <form id="frmpasien" class="form-horizontal" method="post">
      <div class="row">
        <div class="col-md-6">
                ...
                <?php 
                  $px = data_master('tbl_pasien', array('rekmed' => $data->rekmed)); 
                  $selected = ($px->rekmed == $data->rekmed ? 'selected' : '');
                ?>
								<select class="form-control select2_el_pasien input-medium" onchange="getinfopasien2()" id="pasien" name="pasien" style="width: 100%;">
                  <option value="<?= $data->rekmed; ?>" <?= $selected; ?>><?= $px->namapas; ?></option>
                </select>
            ...
            <div class="col-md-9">
              <select name="poliklinik1" id="poliklinik1" class="form-control select2_ap1" onchange="update(); cekruang();" style="width:100%;" data-placeholder="-- Pilih --">
                ...
                <?php foreach($namapos as $pos): ?>
                  <?php if($data->kodepos == $pos->kodepos) { $cek = 'selected'; } else { $cek = ''; } ?>
                  <option value="<?= $pos->kodepos;?>" <?= $cek; ?>><?= $pos->namapost;?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input type="text" class="form-control" id="booking" name="booking" value="<?= $data->mjkn_token; ?>">
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-md-9">
              ...
              <select class="form-control select2_dokter" id="dokter" name="dokter">
									<option value="<?= $data->kodokter;?>"><?= $data->kodokter.' | '.$data->nadokter;?></option>
							</select>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-md-9">
              <!-- <select class="form-control select2_lokasix" id="ruang" name="ruang"></select> -->
              <select class="form-control select2_ap1" id="ruang" name="ruang">
								<?php 
            ...
            <div class="col-md-9">
              <select class="form-control select2_el_penjamin" style="width:100%;" id="vpenjamin" name="vpenjamin" onchange="get_pcare(this.value)">
                ...
                <?php $penjamin = $this->db->get_where("tbl_penjamin", array("cust_id" => 'BPJS'))->result();
								...
								$selected = ($row->cust_id == $data->cust_id ? 'selected':'');
								?>
      ...
      <div class="row">
        ...
        <div class="col-md-6" id="rujukan">
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input type="text" class="form-control" id="norujukan" name="norujukan" value="<?= $data->norujukan; ?>" maxlength="17">
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-6" id="sep">
          <div class="form-group">
            <label class="control-label col-md-3">No. Sep<font color="red">*</font></label>
            <div class="col-md-9">
              <input type="text" class="form-control" id="nosep" name="nosep" value="<?= $data->nosep; ?>" maxlength="19">
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <button type="button" class="btn green" style="float: right;"><i class="fa fa-check-square"></i> Bridging Vclaim</button>
          <button type="button" class="btn blue" style="float: right; margin-right: 10px;" onclick="vpcare();"  id="pcare" type="button"> 
...
function register(){
          ...
          url = "<?php echo site_url('PendaftaranVRS/edit_pasien_register_aps?noreg=')?>"+noregz;
          $.ajax({
               url : url,
               type: "POST",
