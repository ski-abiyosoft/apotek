      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input type="hidden" value="PUGD" name="poliklinik1" id="poliklinik1" class="form-control" readonly>
              <select name="poli1" id="poli1" class="form-control" disabled>
                <option value="PUGD">I G D</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-md-9">
              <select name="dokter" class="form-control" id="dokter"></select>
            </div>
          </div>
        </div>
      </div>
...
$.ajax({
  url: "<?= site_url('PendaftaranVRS/get_dokter_igd');?>",
  type: "POST",
...
function save_pasien() {
  ...
  url = "<?php echo site_url('PendaftaranVRS/tambah_pasien_igd')?>";
  $.ajax({
    url: url,
    type: "POST",
    data: ($('#frmpasien2').serialize()),
