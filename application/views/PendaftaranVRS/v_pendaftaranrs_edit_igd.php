			...
			<div class="row">
				...
				<div class="col-md-6" id="card">
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="nocard" name="nocard" value="<?= $data->nobpjs; ?>">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-actions">
						...
						<a class="btn green" type="button" href="<?= site_url('PendaftaranVRS/entri_igd'); ?>"><i class="fa fa-refresh"></i> Data Baru</a>
