     ...
     <div class="row"> <!-- header -->
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style='margin-bottom:20px'>
               <div class="dashboard-stat yellow">
                    ...
                    <div class="details">
                         ...
                         <div class="desc">
                              TOTAL PASIEN RAWAT JALAN HARI INI
                         </div>
                    </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style='margin-bottom:20px'>
               <div class="dashboard-stat blue">
                    ...
                    <div class="details">
                         <div class="number">
                              <?= $pasienapstoday; ?> PASIEN
                         </div>
                         <div class="desc">
                              TOTAL PASIEN APS HARI INI
                         </div>
                    </div>
                    <a data-toggle="tab" href="#tab6" class="more" onclick="tabaps()">
                         Lihat Detail<i class="m-icon-swapright m-icon-white"></i>
                    </a>
               </div>
          </div>
                              ...
                              <div class="form-body">
                                   <div class="tabbable tabbable-custom tabbable-full-width">
                                        <ul class="nav nav-tabs">
                                             ...
                                             <li class="" id="aps">
                                                  <a href="#tab6" data-toggle="tab" onclick="tab6()">
                                                       APS
                                                  </a>
                                             </li>
                                        </ul>
                                        <div class="tab-content">
                                             ...
                                             <div class="tab-pane" id="tab6" onclick="tab6()">
                                                  <div class="portlet-body">
                                                       <div class="table-toolbar">
                                                            <div class="btn-group"> 
                                                            <?php 
                                                            ...
                                                            <?php }else{ ?>
                                                                 ...
                                                                 <a href="<?php echo base_url()?>PendaftaranVRS/entri_aps" class="btn btn-success">
                                                                      <i class="fa fa-plus"></i> Daftarkan Pasien
                                                                 </a>
                                                            ...
                                                            <div class="btn-group pull-right" id="filter">
                                                                 ...
                                                                 <ul class="dropdown-menu pull-right">
                                                                      <li>
                                                                           <a data-toggle="modal" href="#lupperiodeAPS">Filter Data</a>
                                                                      </li>
                                                                 </ul>
                                                            </div>
                                                       </div>
                                                       <div class="table-responsive">
                                                            <table id="tableAPS" class="table table-striped table-bordered table-hover table-condensed table-scrollable" cellspacing="0" width="100%">
                                                                 <thead class="page-breadcrumb breadcrumb">
                                                                      <tr>
                                                                           <th class="title-white text-center" width="1%">No.</th>
                                                                           <th class="title-white text-center" width="5%">Cab.</th>
...
<!-- filter APS -->
<div class="modal fade" id="lupperiodeAPS" tabindex="-1" role="dialog" aria-hidden="true">
     <div class="modal-dialog modal-small">
          <div class="modal-content">
               <span id="nopilihaps"></span>
               <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Periode Data</h4>	
               </div>
               <div class="modal-body">										 		  
                    <form action="#" class="form-horizontal">
                         <div class="form-group">
                              <label class="col-md-4 control-label">Mulai</label>
                              <div class="col-md-6">
                              <input id="tanggal1aps" name="tanggal1" class="form-control input-medium" type="date" value="<?php echo date('Y-m-d');?>" />
                              </div>
                         </div>
                         <div class="form-group">
                              <label class="col-md-4 control-label">s/d</label>
                              <div class="col-md-6">
                              <input id="tanggal2aps" name="tanggal2" class="form-control input-medium" type="date" value="<?php echo date('Y-m-d');?>" />
               ...
               <div class="modal-footer">
                    <p align="center">
                    <button type="button" id="btnfilter" class="btn green" onclick="filterdataAPS()" data-dismiss="modal">Buka Data</button>
                    </p>		 			
               </div>											
          </div>									
     </div>								
...
function tab6(){
     tableAPS = $('#tableAPS').DataTable({ 
          ...
          "order": [],
          "ajax": {
               "url": "<?php echo site_url('pendaftaranVRS/aps/1')?>",
               "type": "POST"
          },
          "scrollCollapse": false,
          "paging":true,
...
function filterdataAPS(){
     var tgl1 = document.getElementById("tanggal1aps").value;
     var tgl2 = document.getElementById("tanggal2aps").value;
     var id   = 2; 
     var str  = id+'~'+tgl1+'~'+tgl2; 
     tableAPS.ajax.url("<?php echo base_url('pendaftaranVRS/aps/')?>"+str).load();
}
...
function Batalkan(id,tab) {	
     swal({
          ...
          $.ajax({
               ...
               dataType : "json",
               data : {alasan : alasan},
               url : '<?php echo base_url()?>PendaftaranVRS/pembatalan/'+id+'/'+tab,
...
function reload_tableaps()
{
     tableAPS.ajax.reload(null,false); //reload datatable ajax 
}
