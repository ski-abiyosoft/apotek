    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a class="title-white" href="#">Approval Debit / Kredit</a>
                </li>
            </ul>
        </div>
    </div>
							...
							<table id="table" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">							
                               <thead>
                                     <tr class="page-breadcrumb breadcrumb">
                                         <th style="text-align: center;width:20%" class="title-white">Cab.</th>
                                         <th style="text-align: center;width:20%" class="title-white">User ID</th>
                                         <th style="text-align: center;width:20%" class="title-white">No Mutasi</th>
									     <th style="text-align: center;width:20%" class="title-white">Tanggal Mutasi</th>
                                    ...
                                    <?php foreach($listv as $lvkey => $lval): ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-warning btn-sm" type="button" onclick="window.open('/approval_ccdc/cetak/<?= $lval->nomutasi ?>', 'open')"><i class="fa fa-print"></i> Cetak</button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
...
<script>
    ...
    function filterdata(){
        ...
        var str  = tgl1+'~'+tgl2; 
        location.href = "<?php echo base_url();?>approval_ccdc/filter/"+str;
    }
</script>