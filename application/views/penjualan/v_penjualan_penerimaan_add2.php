												...
												<div class="row">
												    <div class="col-md-6">
                                                         <div class="form-group">
                                                           <label class="col-md-3 control-label">Dari Penjamin</label>
													        <div class="col-md-6">
													...
													<div class="col-md-6">
														<div class="form-group">
                                                            <label class="col-md-3 control-label">AR No. #</label>
													        <div class="col-md-4">
...
{	        
    ...
    if(jumlahbayar=="0" || jumlahbayar=="0.00"){
		swal('FINANCE-Penerimaan Piutang','Jumlah pembayaran belum diisi ...',''); 
	} else {
	$.ajax({				
