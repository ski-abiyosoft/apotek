                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <select id="kwiobat" name="kwiobat" class="form-control select2_el_resep_retur input-large" data-placeholder="Pilih..." onchange="getinfopasien(); getinfopasienresep()"></select>
                                            </div>
                                        </div>
                                    </div>
                                </div>
