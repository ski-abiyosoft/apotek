						...
						<div class="portlet-body">
                            ...
                            <thead class="breadcrumb">
                                     <tr>
										 ...
										 <th style="text-align: center">Penjamin/Customer</th>
                                     ...
                                     <tr class="show1" id="row_<?php echo $row->arno;?>">
									     <td align="center"><?php echo $row->koders;?></td> 
									     <td align="center"><?php echo $row->username;?></td> 
                                         <td align="center"><?php echo $row->arno;?></td>
										 <td align="center"><?php echo date('d-m-Y',strtotime($row->ardate));?></td>										 										                                          
										 <!-- <td align="center"><?php echo $row->cek_no;?></td> -->
									     <td><?php echo $row->cust_nama;?></td>
										 <td><?php echo $row->jenis_bayar;?></td>
										 <td><?php echo $row->kas_bank;?></td>
										 <td align="right"><?php echo number_format($row->totalterima,0,'.',',');?></td>
                                                                                                                         
                                         <td style="text-align: center">
                                            <?php
                                               if ($row->posting=='0')
                                                 { ?>	 
											    <!-- <a href="<?php echo base_url()?>penjualan_penerimaan/edit/<?php echo $row->arno;?>">Edit</a> -->
                                                <!-- <a class="delete" href="javascript:">Hapus</a> -->
                                                <a class="btn btn-sm btn-primary" href="<?php echo base_url()?>penjualan_penerimaan/edit/<?php echo $row->arno;?>" title="Edit" ><i class="glyphicon glyphicon-edit"></i> </a>
                                                <a class="btn btn-sm btn-warning print_laporan" id="<?php echo $row->arno; ?>" href="#report" onclick="id_cetak(<?php echo $row->arno; ?>)" data-toggle="modal"><i class="glyphicon glyphicon-print"></i></a>
                                               <?php }?>
                                         </td>
...
$(document).ready(function() {
		...
		$('.modal-title').text('PENERIMAAN PIUTANG');
		
		var param=this.id;				
				
		$("#simkeureport").html('<iframe src="<?php echo base_url();?>penjualan_penerimaan/cetak/'+param+'" frameborder="no" width="100%" height="420"></iframe>');
		});	
	});
...
function filterdata()
{
	...
	var str  = '2~'+tgl1+'~'+tgl2; 
	location.href = "<?php echo base_url();?>penjualan_penerimaan/filter/"+str;
}	
