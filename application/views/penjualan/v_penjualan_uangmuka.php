                                     ...
                                     <tr class="show1" id="row_<?php echo $row->kodeum;?>">
                                         ...
                                         <td style="text-align: center">
                                            <?php
											 ...
											 <a href="<?php echo base_url()?>penjualan_uangmuka/edit/<?php echo $row->kodeum;?>">Edit</a></td>
                                            <?php }?>
                                         </td>
                                         <td style="text-align: center">
                                           <?php
            ...
            function deleteRow ( oTable, nRow)
            {
                if (confirm("Hapus Data Ini?")) {
                    ...
                    $.ajax( {
                        dataType: 'html',
                        type: "POST",
                        url: "<?php echo base_url(); ?>penjualan_uangmuka/hapus/"+mydata,	
                        cache: false,
                        data: mydata,
                        success: function () {
...
function filterdata()
{
	...
	var str  = '2~'+tgl1+'~'+tgl2; 
	location.href = "<?php echo base_url();?>penjualan_uangmuka/filter/"+str;
}	
