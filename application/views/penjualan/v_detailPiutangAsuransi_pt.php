    ...
    <div class="col-md-12">
        <div class="portlet">
            ...
            <div class="portlet-body">
                ...
                <table class="table table-striped table-hover table-bordered" id="keuangan-keluar-list2">
                    <thead>
                        <tr>
                            <th style="text-align: center">Cabang</th>
                            <th style="text-align: center">AR No.</th>
...
$(document).ready(function(){
    $('#keuangan-keluar-list2').DataTable({
		...
		"ajax": {
			"url": "<?php echo site_url('piutang/piutangAsuransi_pt'); ?>",
			"type": "POST"
		},
		...
		"columnDefs": [{
			...
			{
				"targets": [0,1,2,3,4,5,8], //last column
				"className": "text-center",
			},
			{
				"targets": [6,7], //last column
    ...
    return {
        ...
        init: function() {
            ...
            var oTable = $('#keuangan-keluar-list').DataTable({
                ...
                "iDisplayLength": 5,
                "ajax": {
                            "url": "<?php echo site_url('piutang/piutangTerbentuk'); ?>",
                            "type": "POST"
                        },
