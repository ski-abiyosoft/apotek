						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab1">		
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
                                                            <label class="col-md-4 control-label">No. Tukar Faktur</label>
													        <div class="col-md-6">
														        <input type="text" id="nomortukarfaktur" name="nomortukarfaktur" class="form-control rightJustified" placeholder=""  value="<?php echo $data->notukar; ?>" readonly>
													        </div>
													...
													<div class="col-md-6">
														<div class="form-group">
													        ...
													        <div class="col-md-6">
															    <input type="text" id="nomorbukti" name="nomorbukti" class="form-control rightJustified" value="<?php echo $data->terima_no; ?>" readonly>																																															
												...
												<div class="row">		
													...
													<div class="col-md-6">
														<div class="form-group">
                                                            <label class="col-md-4 control-label">No. Faktur / Rekanan</label>
													        <div class="col-md-6">
														        <input type="text" id="nomorfaktur" name="nomorfaktur" class="form-control rightJustified" placeholder="" value="<?php echo $data->invoice_no; ?>">
													        </div>
													...
													<div class="col-md-6">
                                                         <div class="form-group">
                                                           <label class="col-md-4 control-label">Jenis Faktur</label>
													        <div class="col-md-6">
															  <select id="jenis_faktur" name="jenis_faktur" class="form-control select2_el_jenisfaktur" data-placeholder="Pilih..." onkeypress="return tabE(this,event)">
                                                                <option value="<?= $data->jenis;?>"><?= $data->jenis_faktur;?></option>
                                                              </select>
															</div>
													        </div>
													</div>
												...
												<div class="row">	
													...
													<div class="col-md-6">
                                                         <div class="form-group">
                                                           <label class="col-md-4 control-label">Supplier</label>
													        <div class="col-md-6">
																<select id="supplier" name="supplier" class="form-control select2_el_vendor" data-placeholder="Pilih..." onkeypress="return tabE(this,event)">
													...
													<div class="col-md-6">
                                                         <div class="form-group">
                                                           <label class="col-md-4 control-label">Akun Biaya Langsung</label>
													        <div class="col-md-6">
																<select id="acbiaya" name="acbiaya" class="form-control select2_el_akunbiaya" data-placeholder="Pilih..." onkeypress="return tabE(this,event)">
                                                                    <option value="<?= $data->acbiaya;?>"><?= $data->acbiaya." | ".$data->acname;?></option>
                                                                </select>
															</div>
														</div>
													</div>
												...
												<div class="row">
													<div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-6">
                                                            <?php                                                 
                                                                $dateInvoice = date_create($data->tglinvoice);
                                                                $tglinvoice = date_format($dateInvoice,"Y-m-d");
                                                            ?>
														        <input id="tanggal_invoice" name="tanggal_invoice" class="form-control rightJustified" type="date" value="<?php echo $tglinvoice; ?>" />
													        </div>
														</div>
													</div>
													...
													<div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-6">
                                                            <?php                                                 
                                                                $dateDiambil = date_create($data->diambil);
                                                                $diambil = date_format($dateDiambil,"Y-m-d");
                                                            ?>
														        <input id="tanggal_ambil" name="tanggal_ambil" class="form-control rightJustified" type="date" value="<?php echo $diambil; ?>" />
													        </div>
														</div>
													</div> 
												</div>
												...
												<div class="row">
													<div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-6">
                                                            <?php                                                 
                                                                $dateDuedate = date_create($data->duedate);
                                                                $duedate = date_format($dateDuedate,"Y-m-d");
                                                            ?>
														        <input id="jatuh_tempo" name="jatuh_tempo" class="form-control rightJustified" type="date" value="<?php echo $duedate; ?>" />
													        </div>
														</div>
													</div>
													...
													<div class="col-md-6">
                                                         <div class="form-group">
                                                            <label class="col-md-4 control-label">Tanggal Rencana Bayar</label>
													        <div class="col-md-6">
                                                            <?php  
                                                                $dateTglrencanabayar = date_create($data->tglrencanabayar);
                                                                $tglrencanabayar = date_format($dateTglrencanabayar,"Y-m-d");
                                                            ?>
														        <input id="tanggal_rencana_bayar" name="tanggal_rencana_bayar" class="form-control rightJustified" type="date" value="<?php echo $tglrencanabayar; ?>" />
													        </div>
														</div>
													</div> 
												</div>
												...
												<div class="row">
												  <div class="col-md-6">
                                                           ...
                                                           <label class="col-md-4 control-label">Jumlah Tagihan</label>
													        <div class="col-md-6">
															  <input type="text" id="jumlah_tagihan" name="jumlah_tagihan" data-type="currency" onkeyup="cekPpn(this.value)" class="form-control rightJustified" value="<?php echo number_format($data->totaltagihan,0,'.',','); ?>">
															</div>
                                                           </div>
												    ...
												    <div class="col-md-6">
														   <div class="form-group">	
                                                           <label class="col-md-4 control-label">Materai</label>
													        <div class="col-md-6">
															  <input type="text" id="materai" name="materai" data-type="currency" class="form-control rightJustified" value="<?php echo number_format($data->materai,0,'.',','); ?>">
															</div>
                                                           </div>
													</div>
													...
													<div class="col-md-6">
                                                         <div class="form-group">	
                                                           <label class="col-md-4 control-label">Keterangan</label>
													        <div class="col-md-6">
															  <input type="text" id="keterangan" name="keterangan" class="form-control rightJustified" value="<?php echo $data->keterangan; ?>">
															</div>
                                                           </div>
													</div>
													...
													<div class="col-md-6">
                                                         <div class="form-group">	
                                                           <label class="col-md-4 control-label">DPP</label>
													        <div class="col-md-6">
															  <input type="text" id="dpp" name="dpp" data-type="currency" class="form-control rightJustified" value="<?php echo number_format($data->dpp,0,'.',','); ?>" readonly>
															</div>
                                                           </div>
													</div>
												...
												<div class="row">
													...
													<div class="col-md-6">
                                                         <div class="form-group">	
                                                           <label class="col-md-4 control-label">Biaya Lain</label>
													        <div class="col-md-6">
															  <input type="text" id="biayalain" name="biayalain" data-type="currency" class="form-control rightJustified" value="<?php echo number_format($data->biayalain,0,'.',','); ?>">
															</div>
                                                           </div>
													</div>
												  	...
												  	<div class="col-md-6">
														    <div class="form-group">	
																<label class="col-md-4 control-label">PPN (<?php echo (int)$prosentase_ppn; ?>%)</label>
																<div class="col-md-3">
																	<select id="jenis_ppn" name="jenis_ppn" class="form-control" data-placeholder="Pilih..." onkeypress="return tabE(this,event)">
																		<option value=''>Jenis PPn...</option>
                                                                        <?php
                                                                            $arr_key = array_keys($list_jenis_ppn);
                                                                            for($i=0; $i<count($list_jenis_ppn); $i++){
                                                                                $selected = "";
                                                                                if($arr_key[$i] == $jenis_ppn) $selected = "selected";
                                                                                echo "<option $selected value='".$arr_key[$i]."'>".$list_jenis_ppn[$arr_key[$i]]."</option>";
                                                                            }
                                                                        ?>
																	</select>
																</div>
																<div class="col-md-3">
																	<input type="hidden" id="ppn" name="ppn" class="form-control rightJustified" value="<?php echo $prosentase_ppn; ?>">
																	<input type="text" id="ppnrp" name="ppnrp" data-type="currency" class="form-control rightJustified" value="<?php echo number_format($data->ppnrp,0,'.',','); ?>" readonly>
																</div>																
                                                            </div>
														</div> 
													</div>
												...
												<div class="row">
													...
													<div class="col-md-6">
														   <div class="form-group">	
                                                           		<label class="col-md-4 control-label">PPH23</label>
																<span class="d-flex flex-row">
																	<div class="col-md-6">
																		<input type="text" id="pph" name="pph" data-type="currency" class="form-control rightJustified" value="<?php echo number_format($data->pph,0,'.',','); ?>">
																	</div>
																</span>
                                                           </div> 
													</div>
													<div class="col-md-6">
														    <div class="form-group">	
																<label class="col-md-4 control-label">Tagihan + PPn</label>
																<span class="d-flex flex-row">
																	<div class="col-md-6">
																		<input type="text" id="tagihan_plus_ppn" data-type="currency" name="tagihan_plus_ppn" class="form-control rightJustified" value="<?php echo number_format(($data->dpp + $data->ppnrp),0,'.',','); ?>" readonly>
																	</div>
																</span>
						...
						<div class="row form-actions">
							<div class="col-xs-8">
								<div class="wells">		
									...
									<input type="hidden" id="id" name="id" value="<?php echo $data->id; ?>" class="form-control rightJustified" >
...
var tanggal_rencana_bayar  	= $('#tanggal_rencana_bayar').val(); 
    ...
    if(nomortukarfaktur=="" || 
		...
		pph==""
			...
			$.ajax({				
				url:'<?php echo site_url('hutang/save/2')?>',				
