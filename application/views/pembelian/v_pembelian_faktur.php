			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <span class="title-unit">
                      ...
                      - 
                      <span class="title-web">Pembelian <small>Faktur</small>
					</h3>
					...
					<div class="portlet">
						...
						<div class="portlet-body">
                            ...
                            <thead>
                                     ...
                                     <tr class="show1" id="row_<?php echo $row->kodepu;?>">
                                         <td align="center"><?php echo $row->kodepu;?></td>
										 <!--td align="center"><?php echo $row->nomorfaktur;?></td-->
                                         <td align="center"><?php echo date('d-m-Y',strtotime($row->tglpu));?></td>										 
										 ...
										 <td align="center"><?php echo date('d-m-Y',strtotime($row->tgljthtempo));?></td>	
                                         ...
                                         <td style="text-align: center">
                                            <?php
											 ...
											 <a href="<?php echo base_url()?>pembelian_faktur/edit/<?php echo $row->kodepu;?>">Edit</a></td>
                                            <?php }?>
                                         </td>
                                         <td style="text-align: center">
                                           <?php
            ...
            function deleteRow ( oTable, nRow)
            {
                if (confirm("Hapus Data Ini?")) {
                    ...
                    $.ajax( {
                        dataType: 'html',
                        type: "POST",
                        url: "<?php echo base_url(); ?>pembelian_faktur/hapus/"+mydata,	
                        cache: false,
                        data: mydata,
                        success: function () {
...
$(document).ready(function() {
		...
		$("#simkeureport").html('<iframe src="<?php echo base_url();?>pembelian_faktur/cetak/'+param+'" frameborder="no" width="100%" height="420"></iframe>');
		});	
	});
...
function filterdata()
{
	...
	var str  = '2~'+tgl1+'~'+tgl2; 
	location.href = "<?php echo base_url();?>pembelian_faktur/filter/"+str;
}	
