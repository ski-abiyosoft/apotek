					...
					<div class="portlet">
						...
						<div class="portlet-body">
                            ...
                            <thead>
                                     ...
                                     <tr class="show1" id="row_<?php echo $row->kodesi;?>">
                                         <td align="center"><?php echo $row->kodesi;?></td>										 
                                         <td align="center"><?php echo date('d-m-Y',strtotime($row->tglsi));?></td>										 
                                         ...
                                         <td style="text-align: center">
                                            <?php
											 ...
											 <a href="<?php echo base_url()?>penjualan_faktur/edit/<?php echo $row->kodepu;?>">Edit</a></td>
                                            <?php }?>
                                         </td>
                                         <td style="text-align: center">
                                           <?php
