													        ...
													        <div class="col-md-9">
														       <select id="idlap" name="idlap" class="select2me bs-select form-control" data-show-subtext="true" data-placeholder="Pilih...">
																	<optgroup label="Pembelian">	
																		<option data-subtext="101" value="101">Daftar Pesanan Pembelian</option>	
                                                                        <option data-subtext="102" value="102">Daftar Penerimaan Barang</option>																			
																		<option data-subtext="103" value="103">Daftar Faktur Pembelian</option>	
																		<option data-subtext="104" value="104">Daftar Uang Muka Pembelian</option>	
																		<option data-subtext="105" value="105">Daftar Retur Pembelian</option>	
																		<option data-subtext="106" value="106">Pembelian per Pemasok</option>	
																		<option data-subtext="107" value="107">Pembelian per Barang</option>	
																		
																	</optgroup>		
                                                                    <optgroup label="Hutang">	
																		<option data-subtext="201" value="201">Faktur Belum Lunas</option>	
                                                                        <option data-subtext="203" value="203">Umur Hutang</option>	
												...
												<div class="row">												    												
													<div class="col-md-12">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-9">
														       <select id="supp" name="supp" class="select2me bs-select form-control" data-show-subtext="true" data-placeholder="Pilih...">
...
function _urlcetak()
{
	...
	var param= idlap+'~'+tgl1+'~'+tgl2+'~'+supp+'~'+brg+'~'+cbg;	
	
    return baseurl+'pembelian_lap/cetak/'+param;
}
