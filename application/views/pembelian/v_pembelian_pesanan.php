			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <span class="title-unit">
                      ...
                      - 
                      <span class="title-web">Pembelian <small>Pesanan Pembelian</small>
					</h3>
					...
					<div class="portlet">
						...
						<div class="portlet-body">
                            ...
                            <thead>
                                     ...
                                     <tr class="show1" id="row_<?php echo $row->kodepo;?>">
                                         <td align="center"><?php echo $row->kodepo;?></td>
                                         <td align="center"><?php echo date('d-m-Y',strtotime($row->tglpo));?></td>										 
                                         ...
                                         <td style="text-align: center">
                                            <?php
											 ...
											 <a href="<?php echo base_url()?>pembelian_pesanan/edit/<?php echo $row->kodepo;?>">Edit</a></td>
                                            <?php }?>
                                         </td>
                                         <td style="text-align: center">
                                           <?php
                                         ...
                                         <td style="text-align: center">
											...
											<a class="print_laporan" id="<?php echo $row->kodepo;?>" href="#report" data-toggle="modal">Cetak</a> 
                                            <?php }?>
                                         </td>
                                     </tr>
                                     <?php
            ...
            function deleteRow ( oTable, nRow)
            {
                if (confirm("Hapus Data Ini?")) {
                    ...
                    $.ajax( {
                        dataType: 'html',
                        type: "POST",
                        url: "<?php echo base_url(); ?>pembelian_pesanan/hapus/"+mydata,	
                        cache: false,
                        data: mydata,
                        success: function () {
...
$(document).ready(function() {
		...
		$("#simkeureport").html('<iframe src="<?php echo base_url();?>pembelian_pesanan/cetak/'+param+'" frameborder="no" width="100%" height="420"></iframe>');
		});	
	});
...
function filterdata()
{
	...
	var str  = '2~'+tgl1+'~'+tgl2; 
	location.href = "<?php echo base_url();?>pembelian_pesanan/filter/"+str;
}	
