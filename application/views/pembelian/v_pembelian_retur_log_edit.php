          ...
          <div class="row">
            <div class="col-xs-8">
              <div class="wells">
                ...
                <div class="btn-group">
                  <a class="btn red" href="<?= site_url('Pembelian_retur_log') ?>"><i class="fa fa-undo"></i><b> KEMBALI </b></a>
                </div>
...
<script>
  function save() {
    ...
    var pajak = cekppn2;
    $.ajax({
      url: '<?= site_url("Pembelian_retur_log/update_one/?retur_no=") ?>' + noretur,
      ...
      success: function(data) {
        if(data.status == 1){
          ...
          for (i = 1; i < rowCount; i++) {
            ...
            $.ajax({
              url: '<?= site_url() ?>Pembelian_retur_log/update_multi/'+param,
              data: $('#frmpembelian').serialize(),
              type: 'POST',
              dataType: 'JSON',
              success: function(data) {
          ...
          swal({
            ...
            location.href = "<?= site_url('Pembelian_retur_log') ?>";
          });
        } else {
          $("#btnsimpan").attr("disabled", false);
          swal({
