			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <span class="title-unit">
                      ...
                      - 
                      <span class="title-web">Pembelian <small>Uang Muka Pembelian</small>
					</h3>
					...
					<div class="portlet">
						...
						<div class="portlet-body">
                            ...
                            <thead>
                                     ...
                                     <tr class="show1" id="row_<?php echo $row->kodeum;?>">
                                         <td align="center"><?php echo $row->kodeum;?></td>
										 <td align="center"><?php echo $row->nomorfaktur;?></td>
                                         <td align="center"><?php echo date('d-m-Y',strtotime($row->tglum));?></td>										 
                                         ...
                                         <td style="text-align: center">
                                            <?php
											 ...
											 <a href="<?php echo base_url()?>pembelian_uangmuka/edit/<?php echo $row->kodeum;?>">Edit</a></td>
                                            <?php }?>
                                         </td>
                                         <td style="text-align: center">
                                           <?php
            ...
            function deleteRow ( oTable, nRow)
            {
                if (confirm("Hapus Data Ini?")) {
                    ...
                    $.ajax( {
                        dataType: 'html',
                        type: "POST",
                        url: "<?php echo base_url(); ?>pembelian_uangmuka/hapus/"+mydata,	
                        cache: false,
                        data: mydata,
                        success: function () {
...
function filterdata()
{
	...
	var str  = '2~'+tgl1+'~'+tgl2; 
	location.href = "<?php echo base_url();?>pembelian_uangmuka/filter/"+str;
}	
