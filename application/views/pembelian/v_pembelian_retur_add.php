                    ...
                    <thead class="page-breadcrumb breadcrumb">
                      ...
                      <tbody>
                        <tr id="retur_no1">
                          ...
                          <td>
                            <button id="btnhapus1" type='button' onclick=hapusBarisIni(1) class='btn red' disabled><i
                                class='fa fa-trash-o'>
                          </td>
                          <td width="20%">
                            <select name="kode[]" id="kode1" class="select2_el_farmasi_barang form-control"
                              onchange="showbarangname(this.value, 1)" readonly>
                          ...
                          <td width="10%">
                            <input name="qty[]" onchange="totalline(1);total();cekqty(1)" value="1" id="qty1"
                          ...
                          <td width="15%">
                            <input name="harga[]" onchange="totalline(1)" value="0" id="harga1" type="text"
                          ...
                          <td>
                            <a class="btn default" id="lupharga1" data-toggle="modal" href="#lupharga"
                              onclick="getidharga(this.id)" readonly>
                              <i class="fa fa-search"></i>
                            </a>
                          </td>
                          <td width="5%">
                            <input name="disc[]" onchange="totalline(1);total();cekdisc(1)" value="0" id="disc1"
                              type="text" class="form-control rightJustified">
                          </td>
                          <td>
                            <input name="discrp[]" onchange="totalline(1);total();cekdiscrp(1)" value="0" id="discrp1"
                              type="text" class="form-control rightJustified ">
                          </td>
                          <td width="15%">
                            <input name="jumlah[]" id="jumlah1" type="text" class="form-control rightJustified"
                              size="40%" onchange="total()" readonly>
                          </td>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <textarea row="3" class="form-control input-xlarge" placeholder="" name="keterangan"
                            id="keterangan" maxlength="100"></textarea>
                        </div>
          ...
          <div class="row">
            <div class="col-xs-8">
              <div class="wells">
                ...
                <button type="button" onclick="savex()" class="btn blue" id="btnsave"><i class="fa fa-save"></i>
                  <b>Simpan</b></button>
                ...
                <div class="btn-group">
                  <a class="btn red" href="<?php echo base_url('pembelian_retur') ?>"><i class="fa fa-undo"></i><b>
                      KEMBALI </b></a>
                </div>
...
function tambah() {
  ...
  table.append("<tr id='retur_tr" + idrow + "'>" +
    ...
    ")' class='select2_el_farmasi_barang form-control' ><option value=''>--- Pilih Barang ---</option></select></td>" +
    "<td><input name='qty[]'    id=qty" + idrow + " onchange='totalline(" + idrow + ");total();cekqty(" + idrow +
    ...
    "<td><input name='tax[]'  id=tax" + idrow + " onchange='totalline(" + idrow +
    ");total()' value='0' type='checkbox' class='form-control rightJustified'></td>" +
    "<td><a class='btn default' id=lupharga" + idrow +
    " data-toggle='modal' href='#lupharga' onclick='getidharga(this.id)'><i class='fa fa-search'></i></a></td>" +
    "<td><input name='disc[]'   id=disc" + idrow + " onchange='totalline(" + idrow + ");total();cekdisc(" + idrow +
    ")' value='0'  type='text' class='form-control rightJustified'  ></td>" +
    "<td><input name='discrp[]'   id=discrp" + idrow + " onchange='totalline(" + idrow + ");cekdiscrp(" + idrow +
    ")' value='0'  type='text' class='form-control rightJustified'  ></td>" +
