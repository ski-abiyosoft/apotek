                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- select2_el_akundiskonadjust -->
                                            <select id="kasbank" name="kasbank"
                                                ...
                                                <option value='<?php echo $accountno; ?>' selected><?php echo $acname; ?></option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select id="vendor" name="vendor"
                                                ...
                                                <option value='<?php echo $vendor_id; ?>' selected><?php echo $vendor; ?></option>
                                            </select>
                                            ...
                                            <select id="jenis_bayar" name="jenis_bayar"
                                                ...
                                                <?php
                                                    foreach($jenis_pembayaran as $key){
                                                        $selected = '';
                                                        if($key->id == $pay_type) $selected = 'selected';
                                                        echo "<option value='".$key->id."' $selected>".$key->jenis."</option>";
                                                    }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="tanggal_bayar" name="tanggal_bayar"
                                                ...
                                                value="<?php echo date('Y-m-d', strtotime($tanggal_bayar));?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control rightJustified" name="cekgiro"
                                                id="cekgiro" value="<?php echo $cekgiro;?>" >
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="text" class="form-control rightJustified" name="jumlah_bayar"
                                                id="jumlah_bayar" value="<?php echo number_format($jumlah_bayar,0,'.',','); ?>" readonly>
                                            <!-- <span class="input-group-btn">
                        ...
                        <div class="well">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td width="1%"><strong>:</strong></td>
                                    <td width="59" align="right"><strong><span id="jumlah_bayar2"><?php echo number_format($jumlah_bayar,0,'.',','); ?></span></strong></td>
                                </tr>
...
var data_tagihan;
var vndr = '<?php echo $vendor_id; ?>';
$.ajax({
    url: "<?php echo site_url('pembelian_bayar/getData?vendor=')?>" + vndr,
    type: "GET",
    dataType: "JSON",
...
var detail = null;
var tempDetail = null;
detail = JSON.parse('<?php echo json_encode($detail); ?>');
tempDetail = JSON.parse('<?php echo json_encode($detail); ?>');

tagihan_terpilih = tempDetail;
...
if(detail !== ''){
    ...
    // <td style='text-align: center'><input type='text' id='diskonrp[]' name='diskonrp[]' value='"+currencyFormat(value.diskonrp)+"' class='form-control rightJustified'  data-type='currency'></td>\
    //                                 <td style='text-align: center'>\
    //                                     <select id='akundiskon"+i+"' name='akundiskon[]' class='form-control  select2_el_akundiskonadjust' data-placeholder='Pilih...' readonly>\
    //                                         <option value='61231' selected>61231 | Diskon Beli</option>\
    //                                     </select>\
    //                                 </td>\
    //                                 <td style='text-align: center'><input type='text' id='adjustment[]' name='adjustment[]' value='"+currencyFormat(value.adjustment)+"' class='form-control rightJustified'  data-type='currency'></td>\
    //                                 <td style='text-align: center'>\
    //                                     <select id='akunjust"+i+"' name='akunjust[]' class='form-control  select2_el_akundiskonadjust' data-placeholder='Pilih...' readonly>\
    //                                         <option value='7822' selected>7822 | Donasi</option>\
    //                                     </select>\
    //                                 </td>\
    $.each(detail, function( key, value ) {
        $('#daftar_tagihan_pilihan').append("<tr>\
                                    ...
                                    <td style='text-align: center'>" + currencyFormat(value.totalhutang) + "</td>\
                                    <td style='text-align: center'><input type='text' id='dibayar[]' name='dibayar[]' value='"+currencyFormat(value.dibayar)+"' onkeyup='hitungJumlahBayar();' class='form-control rightJustified'  data-type='currency'></td>\
                        ...
                        .tglinvoice + "'>\
                                    <input type='hidden' id='duedate[]' name='duedate[]' value='" + value.due_date + "'>\
...
function tambah_data(id, accountno) {
    ...
    if (
        ...
        $.ajax({
            url: "<?php echo site_url('pembelian_bayar/getData?vendor=')?>" + vendor,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                data_tagihan = data;
                ...
                $.each(data, function(key, value) {
                    ...
                    if(detail != null && detail != ''){
                        find2 = detail.some(element => {
                                if (value.terima_no === element.terima_no) {
                                    return 'checked';
                                }
                        });

                        if(find2) checked = 'checked';
                    }

                    var find3 = false;
                    if(tempDetail != null){
                        find3 = tempDetail.some(element => {
                                if (value.terima_no === element.terima_no) {
                                    return true;
                                }
                        });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    // <td style='text-align: center'><input type='text' id='diskonrp[]' name='diskonrp[]' class='form-control rightJustified'  data-type='currency'></td>\
                    //     <td style='text-align: center'>\
                    //         <select id='akundiskon"+i+"' name='akundiskon[]' class='form-control  select2_el_akundiskonadjust' data-placeholder='Pilih...' >\
                    //             <option value='61231' selected>61231 | Diskon Beli</option>\
                    //         </select>\
                    //     </td>\
                    //     <td style='text-align: center'><input type='text' id='adjustment[]' name='adjustment[]' class='form-control rightJustified'  data-type='currency'></td>\
                    //     <td style='text-align: center'>\
                    ...
                    $('#daftar_tagihan_pilihan').append("<tr>\
                                    ...
                                    <td style='text-align: center'>" + moment(value.duedate).format('DD/MM/YYYY') + "</td>\
                                    <td style='text-align: center'>" + currencyFormat(value.totaltagihan) + "</td>\
                                    <td style='text-align: center'><input type='text' id='dibayar[]' name='dibayar[]' onkeyup='hitungJumlahBayar();' class='form-control rightJustified' data-type='currency'></td>\
                                    <td style='text-align: center'><a href='#' onclick=hapus_tagihan('" + (value
                            .terima_no) + "')>Hapus</a></td>\
                                    <input type='hidden' id='terima_no[]' name='terima_no[]' value='" + value
                        .terima_no + "'>\
...
function hitungJumlahBayar(){
    var dibayar     = $("input[name='dibayar[]']").map(function(){return $(this).val();}).get();
    var diskonrp    = $("input[name='diskonrp[]']").map(function(){return $(this).val();}).get();
    var adjustment  = $("input[name='adjustment[]']").map(function(){return $(this).val();}).get();
    ...
    var jumlah_bayar = 0;
    if(dibayar.length != 0){
        jumlah_bayar = dibayar.reduce(myFunc);
    }
...
async function hapus_tagihan(id){
    ...
    dibayar = $("input[name='dibayar[]']").map(function(){return $(this).val();}).get();
    diskonrp = $("input[name='diskonrp[]']").map(function(){return $(this).val();}).get();
    akundiskon = $("select[name='akundiskon[]']").map(function(){return $(this).val();}).get();
    adjustment = $("input[name='adjustment[]']").map(function(){return $(this).val();}).get();
    akunjust = $("select[name='akunjust[]']").map(function(){return $(this).val();}).get();

    console.log($("input[name='dibayar[]']").map(function(){return $(this).val();}).get());
    ...
    $.each(tagihan_terpilih, function( key, value ) {
        if(value.terima_no != id){
            ...
            // <td style='text-align: center'><input type='text' id='diskonrp[]' name='diskonrp[]' value='"+diskonrp[no]+"' onkeyup='hitungJumlahBayar();' class='form-control rightJustified' ></td>\
            //     <td style='text-align: center'>\
            //         <select id='akundiskon[]' name='akundiskon[]' class='form-control  select2_el_akundiskonadjust' data-placeholder='Pilih...' >\
            //             <option value='"+akundiskon[no]+"' selected>"+akundiskon[no]+" | "+akundiskon_name[no]+" </option>\
            //         </select>\
            //     </td>\
            //     <td style='text-align: center'><input type='text' id='adjustment[]' name='adjustment[]' value='"+adjustment[no]+"' onkeyup='hitungJumlahBayar();' class='form-control rightJustified' ></td>\
            //     <td style='text-align: center'>\
            //         <select id='akunjust[]' name='akunjust[]' class='form-control select2_el_akundiskonadjust' data-placeholder='Pilih...' >\
            //             <option value='"+akunjust[no]+"' selected>"+akunjust[no]+" | "+akunjust_name[no]+" </option>\
            //         </select>\
            //     </td>\
            ...
            $('#daftar_tagihan_pilihan').append("<tr>\
                            <td style='text-align: center'>" + value.invoice_no + "</td>\
                                    ...
                                    <td style='text-align: center'>" + moment(value.tglinvoice).format('DD/MM/YYYY') + "</td>\
                                    <td style='text-align: center'>" + moment(value.duedate).format('DD/MM/YYYY') + "</td>\
                                    <td style='text-align: center'>" + currencyFormat(tghn) + "</td>\
                                    <td style='text-align: center'><input type='text' id='dibayar[]' name='dibayar[]' value='"+dibayar[no]+"' onkeyup='hitungJumlahBayar();' class='form-control rightJustified' ></td>\
                                    <td style='text-align: center'><a href='#' onclick=hapus_tagihan('" + (value
                                .terima_no) + "')>Hapus</a></td>\
                                        <input type='hidden' id='terima_no[]' name='terima_no[]' value='" + value
                            .terima_no + "'>\
...
function save() {
    ...
    var dibayar                 = $("input[name='dibayar[]']").map(function(){return $(this).val();}).get();
    // var diskonrp                = $("input[name='diskonrp[]']").map(function(){return $(this).val();}).get();
    // var akundiskon              = $("input[name='akundiskon[]']").map(function(){return $(this).val();}).get();
    // var adjustment              = $("input[name='adjustment[]']").map(function(){return $(this).val();}).get();
    // var akunjust                = $("input[name='akunjust[]']").map(function(){return $(this).val();}).get();
                ...
                if(dt.status === true){
                    swal({
                        ...
                        html: "<p> No. Bukti   : <b>" + dt.data + "</b> </p>" +
                            // "Tanggal :  " + moment(tanggal_bayar).format('DD/MM/YYYY'),                          
