												...
												<div class="row">
                                                           ...
                                                           <label class="col-md-3 control-label">Pembayaran Ke</label>
													        <div class="col-md-6">
															  <select id="supp" name="supp" class="form-control select2_el_vendor" data-placeholder="Pilih..." onkeypress="return tabE(this,event)">
            												    <option value="<?= $rowh->vendor_id;?>"><?= $rowh->vendor_id;?></option>
            												  </select>
													...
													<div class="col-md-6">
														<div class="form-group">
													        ...
													        <div class="col-md-4">
															    <input type="text" class="form-control input-medium" name="nomorbukti"  id="nomorbukti" value="<?php echo $rowh->ap_id;?>" readonly>																																															
                                                         ...
                                                         <div class="form-group">
													        ...
													        <div class="col-md-4">
														       <div class="input-icon">
															    ...
															    <input id="tanggal" name="tanggal" class="form-control date-picker input-medium" type="text" value="<?php echo date('d-m-Y',strtotime($rowh->pay_date));?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years" placeholder="" onkeypress="return tabE(this,event)"/>
													    	   </div>
													        </div>
												  ...
												  <div class="col-md-6">
                                                         <div class="form-group">	
                                                           <label class="col-md-3 control-label">Nilai Pembayaran</label>
													        <div class="col-md-6">
															  <div class="input-group">
                                                                 <input type="text" class="form-control input-medium rightJustified" name="jumlahbayar"  id="jumlahbayar" value="<?php echo $rowh->totalbayar;?>" readonly>	
													...
													<div class="col-md-6">
                                                         <div class="form-group">	
                                                           <label class="col-md-3 control-label">Keterangan</label>
													        <div class="col-md-6">
															  <div class="input-group">
                                                                 <input type="text" class="form-control input-large" name="keterangan"  id="keterangan" value="<?php echo $rowh->ket;?>" >	
...
{	        
  ...
  function totalline(id)
  {
   ...
   if((jumlah1+uangmuka1)>hutang1){
	  swal('FINANCE-Pembayaran Hutang','Jumlah pembayaran melebihi Tagihan ...','');  
	...
	$.ajax({
        ...
        {	
            ...
            for(i=0; i <= data.length-1; i++){		
			  ...
			  document.getElementById("faktur"+i).value=data[i].invoice_no;
			  document.getElementById("tglfaktur"+i).value=data[i].tanggal;		    
			  document.getElementById("totfaktur"+i).value=formatCurrency1(data[i].totalhutang);		    
              document.getElementById("hutang"+i).value=formatCurrency1(data[i].totalhutang);		    
			  document.getElementById("uangmuka"+i).value=formatCurrency1(0);		    
			  document.getElementById("bayar"+i).value=formatCurrency1(data[i].dibayar);				  
