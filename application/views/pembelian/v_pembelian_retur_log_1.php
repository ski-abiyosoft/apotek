...
<div class="row">
  <div class="col-md-12">
    ...
    <ul class="page-breadcrumb breadcrumb">
      ...
      <li>
        <a class="title-white" href="<?= base_url(); ?>Pembelian_retur_log">
          Data Retur
        </a>
      </li>
    </ul>
    ...
    <div class="portlet">
      ...
      <div class="portlet-body">
        <div class="table-toolbar">
          <div class="btn-group">
            <?php if ($akses->uadd) : ?>
              <a href="<?= base_url() ?>pembelian_retur_log/entri" class="btn btn-success">
...
<script>
  ...
  table = $('#datatable').DataTable({
    ...
    "order": [],
    "ajax": {
      "url": "<?php echo site_url('Pembelian_retur_log/data_list/1') ?>",
      "type": "POST"
    },
  ...
  function Batalkan(id) {
    swal({
      ...
      $.ajax({
        ...
        url: '<?php echo base_url() ?>Pembelian_retur_log/hapus/' + id,
  ...
  function filterdata() {
    ...
    table.ajax.url("<?php echo base_url('Pembelian_retur_log/data_list/') ?>" + str).load();
  }
</script>