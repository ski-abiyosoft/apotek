			...
			<div class="row">
				<div class="col-md-12">
					...
					<span class="title-unit">
                      ...
                      - 
                      <span class="title-web">Pembelian <small>Laporan</small>
					</h3>
										...
										<ul class="ver-inline-menu tabbable margin-bottom-10">
											<li class="active">
												<a data-toggle="tab" href="#tab_1-1">
													<i class="fa fa-angle-double-right"></i> Daftar Pesanan Pembelian
												</a>
												<span class="after">
												</span>
											</li>											
											<li>
												<a data-toggle="tab" href="#tab_3-3">
													<i class="fa fa-angle-double-right"></i> Daftar Penerimaan Barang
												</a>
											</li>											
											<li>
												<a data-toggle="tab" href="#tab_5-5">
													<i class="fa fa-angle-double-right"></i> Daftar Faktur Pembelian
												</a>
											</li>											
											<li>
												<a data-toggle="tab" href="#tab_7-7">
													<i class="fa fa-angle-double-right"></i> Uang Muka Pembelian
												</a>
											</li>
											...
											<li>
												<a data-toggle="tab" href="#tab_9-9">
													<i class="fa fa-angle-double-right"></i> Daftar Retur Pembelian
												</a>
											</li>											
											<li>
												<a data-toggle="tab" href="#tab_9-9">
													<i class="fa fa-angle-double-right"></i> Pembelian per Pemasok
												</a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_9-9">
													<i class="fa fa-angle-double-right"></i> Pembelian per Barang
												</a>
											</li>											
											...
											<li>
												<a data-toggle="tab" href="#tab_9-9">
													<i class="fa fa-angle-double-right"></i> Faktur Belum Lunas
												</a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_9-9">
													<i class="fa fa-angle-double-right"></i> Umur Hutang
												</a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_9-9">
													<i class="fa fa-angle-double-right"></i> Buku Besar Pembantu Hutang
												</a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_9-9">
													<i class="fa fa-angle-double-right"></i> Histori Hutang
												</a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_9-9">
													<i class="fa fa-angle-double-right"></i> Rincian Umur Hutang
												</a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_9-9">
													<i class="fa fa-angle-double-right"></i> Rincian Buku Pembantu Hutang
												</a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_9-9">
													<i class="fa fa-angle-double-right"></i> Pesanan per Barang (Belum Proses)
												</a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_9-9">
													<i class="fa fa-angle-double-right"></i> Pembayaran Faktur
												</a>
											</li>
												...
												<form name="frmlap1" id="frmlap1" role="form" action="#">
                                                  <table class="table table-bordered1 table-striped1">
													...
													<div class="col-md-4">
															...
															<input id="tanggal11" name="tanggal11" class="form-control input-medium" type="date" value="<?php echo date('Y-m-d');?>" />
														
													</div>
													<div class="col-md-4">

															<input id="tanggal12" name="tanggal12" class="form-control input-medium" type="date" value="<?php echo date('Y-m-d');?>" />
