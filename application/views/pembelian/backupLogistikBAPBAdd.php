                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-1">
                                            <input type="checkbox" value="1" name="cekpo" id="cekpo" checked="checked"
                                                class="form-control" onchange="cekpo2();">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="nopo" class="col-md-9">
                                            <select id="nomorpo" name="nomorpo"
                                                class="form-control select2_el_farmasi_po2" data-placeholder="Pilih..."
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" name="ref" id="ref" class="form-control" value="0"
                                                disabled>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" name="rate" id="rate" class="form-control" value="0"
                                                readonly>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table id="datatable"
                                        ...
                                        style="overflow: auto; white-space: nowrap; display: inline-block;">
                                        ...
                                        <thead class="page-breadcrumb breadcrumb">
                                            <!-- <th class="title-white" width="5%" style="text-align: center">Delete</th>
														...
														<th class="title-white" width="14%" style="text-align: center"></th>                    									 -->
                                            <th class="title-white" width="5%" style="text-align: center" id="kh">Delete
                                            </th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td id="kolom1">
                                                    <button type='button' onclick="hapusBarisIni(1)" class='btn red'
                                                        id="btnhapus1"><i class='fa fa-trash-o'>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input name="qty[]" onchange="totalline(1);total()" value="1"
                                                        id="qty1" type="text" class="form-control rightJustified">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <!-- <input name="harga[]"  onchange="totalline(1);total();" value="0" id="harga1" type="text" class="form-control rightJustified" readonly> -->
                                                    <input name="harga[]" onchange="totalline(1); total(); cekharga(1);"
                                                        value="0" id="harga1" type="text"
                                                        class="form-control rightJustified">
                                                </td>
                                                <td>
                                                    <input name="disc[]" onchange="totalline(1);total();changedisc(1)"
                                                        value="0" id="disc1" type="text"
                                                        class="form-control rightJustified">
                                                </td>
                                                <td>
                                                    <input name="discrp[]"
                                                        onchange="totalline(1);total(); changediscrp(1)" value="0"
                                                        id="discrp1" type="text" class="form-control rightJustified ">
                                                </td>
                                                <td>
                                                    <input type="checkbox" name="tax[]" value=0 id="tax1"
                                                        class="form-control" onchange="totalline(1);total();">
                                                </td>

                                                <td>
                                                    <input name="jumlah[]" id="jumlah1" type="text"
                                                        class="form-control rightJustified" size="40%" readonly>
                                                </td>
                                                <td>
                                                    <input name="expire[]" onchange="totalline(1);total()" value=""
                                                        id="expire1" type="date" class="form-control">
                                                </td>
                                                <td>
                                                    <input name="po[]" onchange="totalline(1);total()" value="" id="po1"
                                                        type="text" class="form-control">
                                                </td>
                                                <!-- <td>
															<input type="hidden" name="vatrp[]" value=0 id="vatrp1" >
														</td> -->
                    ...
                    <div class="row">
                        <div class="col-xs-9">
                            <div class="wells">
                                ...
                                <div class="btn-group">
                                    <a class="btn red" href="<?php echo base_url('logistik_bapb/')?>"><i
        ...
        success: function(data) {
            ...
            if (data.status == 1) {
                swal({
                    ...
                    // let abc = data.harga;
                    $('#harga' + id + '').val(separateComma(data.harga.toFixed(0)));
                ...
                $('#harga' + id + '').val(separateComma(harga.toFixed(0)));
                $('#jumlah' + id + '').val(separateComma(jumlah_new2.toFixed(0)));
            }
        }
    });
}
...
//     totalline(id);
//     $.ajax({
//         url: "<?php echo base_url();?>logistik_bapb/cekharga/?kode=" + kode + "&harga=" + harga,
//         type: "GET",
//         dataType: "JSON",
//         success: function(data) {
//             var vtotal = $('#_vtotal').text();
...
// function ubahdsc(id) {
//     $('#disc' + id + '').value = 0;
//     $('#disc' + id + '').attr('readonly', true);
//     var cek = document.getElementById('discrp' + id + '').value;
//     var qty = document.getElementById('qty' + id + '').value;
//     var harga = document.getElementById('harga' + id + '').value;
//     var discrp = document.getElementById('discrp' + id + '').value;

//     if (discrp > 0) {
//         var hasil = qty * harga - discrp;
//     } else {
//         var hasil = qty * harga;
//     }
//     $('#jumlah' + id + '').value = separateComma(hasil);
//     var vtotal = $('#_vtotal').text();
//     var total = parseInt(vtotal.replaceAll(',', ''));
//     // if (total >= '5000000') {
//     //     $('#materai').val("10000").change();
...
function tambah() {
    ...
    var akun = "<select name='kode[]' id=kode" + idrow +
        " class='select2_el_farmasi_barang2 form-control' onchange='showbarangname(this.value," + idrow + ")' >";
    ...
    var hrg = "<input name='harga[]'  id=harga" + idrow + " onchange='totalline(" + idrow + ");cekharga(" + idrow +
        ");' value='0'  type='text' class='form-control rightJustified'> ";

    var diskper = "<input name='disc[]'   id=disc" + idrow + " onchange='totalline(" + idrow + ");total();changedisc(" +
        idrow + ")' value='0'  type='text' class='form-control rightJustified'  >";

    var diskrp = "<input name='discrp[]' id=discrp" + idrow + " onchange='totalline(" + idrow + ");changediscrp(" +
        idrow +
        ");' value='0'  type='text' class='form-control rightJustified'  >";

    var taxx = "<input type='checkbox' value=0 name='tax[]' id=tax" + idrow + " onchange='totalline(" + idrow +
        ");total();' class='form-control'>";
    // var taxx="<input type='checkbox' name='tax[]' value='1' id=tax"+idrow+" onchange='totalline("+idrow+");total();' class='form-control'>";
                        ...
                        success: function(data) {
                            if (data.status == '1') {
                                ...
                                for (i = 1; i < rowCount; i++) {
                                    ...
                                    var jumlah = Number(jumlahx.replace(
                                        /[^0-9\.]+/g, ""));
                                    ...
                                    $.ajax({
                                        url: '<?= site_url() ?>Logistik_bapb/save_multi/?kode=' +
                                            kode + '&qty=' + qty + '&sat=' +
                                            sat + '&harga=' + harga +
                                            '&disc=' + disc + '&discrp=' +
                                            discrp + '&vat=' + vat +
                                ...
                                $.ajax({
                                    url: '<?= site_url() ?>Logistik_bapb/save_one_u/?totvatrp=' +
...
function total() {
    ...
    for (var i = 1; i < rowCount; i++) {
        ...
        $.ajax({
            url: '<?php echo base_url();?>logistik_bapb/cekppn',
            type: "GET",
            dataType: "json",
            success: function(data) {
