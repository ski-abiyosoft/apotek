...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a class="title-white" href="<?php echo base_url('kasir_uangmuka');?>">Poliklinik</a>
                <i style="color:white;" class="fa fa-angle-right"></i>
            </li>
            <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input readonly value="<?= isset($ttv->kodepos)? $ttv->kodepos : $data_pas->kodepos ?>" id="poli_dok" name="poli_dok" class="form-control" type="text">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea style="resize:none" readonly id="alergi_dok" name="alergi_dok"  placeholder="" class="form-control"><?= $data_pas->alergi ?></textarea>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <tr>
                                ...
                                <td rowspan="3" >
                                        <div class="col-md-9"><br>
                                            <textarea style="resize:none" name="simpulfisik" placeholder="" class="form-control" rows="4" ><?= $ttv->pfisik ?></textarea>
                                            <span class="help-block"></span>
                                        </div>
                                </td>
                                            ...
                                            <div class="tab-pane active" id="tab2">
                                                <div class="portlet-body">
                                                    <div class="table-responsive">
                                                        ...
                                                        <tr>
                                                            <td align="center" >
                                                            <textarea style="resize:none" class="form-control" name="kelawal" id="kelawal" cols="auto" rows="5"><?= $ttv->keluhanawal ?></textarea>
                                                            </td>
                                                            <td align="center" >
                                                            <textarea style="resize:none" class="form-control" name="pemeriksaan" id="pemeriksaan" cols="auto" rows="5"><?= $ttv->pfisik ?></textarea>
                                                            </td>
                                                            <td align="center" >
                                                            <textarea style="resize:none" class="form-control" name="diagmas" id="diagmas" cols="auto" rows="5"><?= $ttv->diagnosa ?></textarea>
                                                            </td>
                                                            <td align="center" >
                                                            <textarea style="resize:none" class="form-control" name="teresep" id="teresep" cols="auto" rows="5"><?= $ttv->resep ?></textarea>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                            <textarea style="resize:none" class="form-control" name="diagnosa" id="diagnosa" cols="auto" rows="5"><?= $ttv->diagu ?></textarea>
                                                            </td>
                                                            <td align="center">
                                                            <textarea style="resize:none" class="form-control" name="tindu" id="tindu" cols="auto" rows="5"><?= $ttv->tindu ?></textarea>
                                                            </td>
                                                            <td align="center" >
                                                            <textarea style="resize:none" class="form-control" name="anjuran" id="anjuran" cols="auto" rows="5"><?= $ttv->anjuran ?></textarea>
                                                            </td>
                                                        ...
                                                        <table id="datatable_diagnosa" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable" border="1">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <select name="diag[]" id="diag1" class="select2_el_icdind form-control input-largex" onchange="testing(this.value)">
                                                                        </select>
                                                        ...
                                                        <table id="datatable_poli_tindakan" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable " border="1">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td align="left" >
                                                                        <input name="dokter[]" id="dokter1" type="text" class="form-control" readonly>
                                                                    </td>
                                                                    
                                                                    <td align="left" >
                                                                        <input name="paramedis[]" id="paramedis1" type="text" class="form-control" readonly>
                                                                    </td>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td width="2%"  align="center" >
                                                                        <button type='button' onclick="hapusBaris_alkes(1)" class='btn red'><i class='fa fa-trash-o'></i>
                                                                        </button>                                        
                                                                    </td>
                                                                    ...
                                                                    <td width="15%">
                                                                        ...
                                                                        <input name="bbn_hide[]" id="bbn_hide1" type="hidden" class="form-control" >

                                                                    </td>

                                                                    <td width="30%">
                                                                        <select name="kdalkes[]" id="kdalkes1"
                                                                            class="select2_el_farmasi_barang form-control input-largex" onchange="show_alkes(this.value, 1)">
                                                                        </select>
                                                                    ...
                                                                    <td width="10%">
                                                                        <input name="qtyalkes[]" id="qtyalkes1" type="number" class="form-control " >
                                                                    </td>
                                                                    <td width="15%">
...
<script>
    ...
    function save(){	    
        ...
        $.ajax({			
            url: "<?php echo base_url(); ?>poliklinik/ajax_add_dokter/1",
