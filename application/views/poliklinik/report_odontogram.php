...
.kop_judul   {font-size:38px;text-align:center; font-weight:bold;text-transform: uppercase;}
.kop_address {font-size:12px;text-align:center; font-weight:bold;}
...
<table style="border-collapse:collapse;font-family: Century Gothic; font-size:12px; color:#000;" width="100%"  border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <img src="<?= $org_logo ?>"  width="100" height="100" /></td>
    ...
    <tr><td colspan="18" style="border-top:2px solid #000;"></td></tr> 
    <tr><td colspan="18">&nbsp;</td></tr> 
    <tr><td colspan="18">&nbsp;</td></tr> 
</table>
...
<table style="border-collapse:collapse;font-family: tahoma; font-size:12px" width="100%" align="center" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
        <td colspan="21" style="text-align:center;font-size:22px;border-bottom: none;color:#120292;"><b>LAPORAN ODONTOGRAM</b></td>
    </tr> 
        
    <tr>
        <td colspan="21" style="text-align:center;font-size:15px;border-top: none;"></td>
    </tr>
...
<table style="border-collapse:collapse;font-family: tahoma; font-size:12px" width="100%" align="center" border="0" cellspacing="1" cellpadding="3">
    <tr>
        ...
        <td><b><?= $data_pas->namapas ?></b></td>
    </tr> 

    <tr>
        <td width="10%"><b>NOREG :</b></td>
        <td><b><?= $noreg ?></b></td>
    </tr> 
...
<table style="border-collapse:collapse;font-family: tahoma; font-size:12px" width="100%" align="center" border="1" cellspacing="1" cellpadding="3" >
	...
	<tr>
        <td width="5%" align="center" style="border-right: none;" >&nbsp;</td>
		<td width="95%" align="center" style="border-left: none;" ><br/>
			
			<div id="svgselect" style="width: 710px; height: 230px; "> <!-- background-color:red -->
				<svg version="1.1" height="800px; height: 230px;" >
					<g transform="scale(1.6)" id="gmain">
						
						<g id="P17" transform="translate(25,0)">
						<?php
                        
						$P17C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P17-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P17T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P17-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P17B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P17-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P17R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P17-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P17L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P17-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<?php
						$P16C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P16-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P16T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P16-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P16B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P16-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P16R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P16-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P16L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P16-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<?php
						$P15C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P15-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P15T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P15-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P15B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P15-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P15R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P15-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P15L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P15-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<?php
						$P14C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P14-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P14T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P14-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P14B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P14-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P14R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P14-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P14L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P14-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<?php
						$P13C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P13-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P13T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P13-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P13B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P13-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P13R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P13-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P13L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P13-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<?php
						$P12C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P12-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P12T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P12-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P12B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P12-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P12R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P12-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P12L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P12-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P11" transform="translate(175,0)">
							<?php
						$P11C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P11-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P11T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P11-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P11B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P11-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P11R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P11-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P11L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P11-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P55" transform="translate(75,40)">
							<?php
						$P55C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P55-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P55T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P55-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P55B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P55-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P55R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P55-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P55L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P55-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P54" transform="translate(100,40)">
							<?php
						$P54C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P54-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P54T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P54-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P54B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P54-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P54R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P54-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P54L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P54-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P53C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P53-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P53T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P53-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P53B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P53-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P53R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P53-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P53L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P53-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P52" transform="translate(150,40)">
							<?php
						$P52C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P52-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P52T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P52-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P52B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P52-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P52R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P52-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P52L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P52-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P51" transform="translate(175,40)">
							<?php
						$P51C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P51-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P51T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P51-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P51B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P51-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P51R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P51-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P51L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P51-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P85" transform="translate(75,80)">
							<?php
						$P85C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P85-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P85T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P85-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P85B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P85-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P85R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P85-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P85L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P85-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P84" transform="translate(100,80)">
							<?php
						$P84C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P84-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P84T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P84-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P84B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P84-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P84R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P84-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P84L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P84-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P83" transform="translate(125,80)">
							<?php
						$P83C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P83-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P83T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P83-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P83B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P83-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P83R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P83-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P83L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P83-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P82" transform="translate(150,80)">
							<?php
						$P82C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P82-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P82T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P82-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P82B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P82-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P82R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P82-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P82L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P82-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P81" transform="translate(175,80)">
							<?php
						$P81C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P81-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P81T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P81-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P81B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P81-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P81R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P81-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P81L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P81-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P48" transform="translate(0,120)">
							<?php
						$P48C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P48-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P48T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P48-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P48B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P48-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P48R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P48-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P48L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P48-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P47" transform="translate(25,120)">
							<?php
						$P47C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P47-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P47T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P47-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P47B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P47-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P47R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P47-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P47L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P47-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P46" transform="translate(50,120)">
							<?php
						$P46C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P46-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P46T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P46-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P46B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P46-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P46R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P46-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P46L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P46-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P45" transform="translate(75,120)">
							<?php
						$P45C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P45-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P45T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P45-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P45B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P45-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P45R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P45-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P45L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P45-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P44" transform="translate(100,120)">
							<?php
						$P44C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P44-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P44T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P44-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P44B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P44-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P44R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P44-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P44L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P44-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P43" transform="translate(125,120)">
							<?php
						$P43C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P43-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P43T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P43-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P43B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P43-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P43R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P43-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P43L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P43-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P42" transform="translate(150,120)">
							<?php
						$P42C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P42-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P42T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P42-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P42B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P42-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P42R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P42-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P42L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P42-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P41" transform="translate(175,120)">
							<?php
						$P41C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P41-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P41T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P41-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P41B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P41-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P41R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P41-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P41L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P41-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P21" transform="translate(210,0)">
							<?php
						$P21C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P21-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P21T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P21-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P21B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P21-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P21R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P21-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P21L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P21-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P22" transform="translate(235,0)">
							<?php
						$P22C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P22-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P22T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P22-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P22B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P22-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P22R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P22-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P22L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P22-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P23" transform="translate(260,0)">
							<?php
						$P23C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P23-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P23T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P23-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P23B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P23-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P23R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P23-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P23L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P23-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P24" transform="translate(285,0)">
							<?php
						$P24C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P24-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P24T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P24-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P24B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P24-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P24R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P24-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P24L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P24-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P25" transform="translate(310,0)">
							<?php
						$P25C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P25-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P25T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P25-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P25B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P25-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P25R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P25-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P25L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P25-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P26" transform="translate(335,0)">
							<?php
						$P26C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P26-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P26T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P26-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P26B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P26-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P26R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P26-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P26L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P26-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P27" transform="translate(360,0)">
							<?php
						$P27C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P27-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P27T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P27-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P27B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P27-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P27R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P27-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P27L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P27-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P28" transform="translate(385,0)">
							<?php
						$P28C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P28-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P28T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P28-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P28B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P28-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P28R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P28-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P28L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P28-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P61" transform="translate(210,40)">
							<?php
						$P61C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P61-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P61T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P61-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P61B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P61-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P61R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P61-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P61L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P61-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P62" transform="translate(235,40)">
							<?php
						$P62C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P62-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P62T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P62-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P62B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P62-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P62R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P62-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P62L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P62-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P63" transform="translate(260,40)">
							<?php
						$P63C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P63-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P63T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P63-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P63B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P63-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P63R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P63-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P63L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P63-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P64" transform="translate(285,40)">
							<?php
						$P64C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P64-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P64T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P64-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P64B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P64-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P64R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P64-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P64L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P64-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P65" transform="translate(310,40)">
							<?php
						$P65C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P65-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P65T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P65-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P65B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P65-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P65R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P65-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P65L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P65-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P71" transform="translate(210,80)">
							<?php
						$P71C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P71-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P71T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P71-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P71B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P71-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P71R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P71-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P71L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P71-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P72" transform="translate(235,80)">
							<?php
						$P72C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P72-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P72T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P72-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P72B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P72-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P72R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P72-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P72L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P72-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P73" transform="translate(260,80)">
							<?php
						$P73C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P73-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P73T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P73-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P73B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P73-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P73R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P73-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P73L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P73-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P74" transform="translate(285,80)">
							<?php
						$P74C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P74-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P74T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P74-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P74B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P74-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P74R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P74-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P74L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P74-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P75" transform="translate(310,80)">
							<?php
						$P75C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P75-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P75T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P75-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P75B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P75-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P75R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P75-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P75L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P75-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P31" transform="translate(210,120)">
							<?php
						$P31C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P31-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P31T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P31-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P31B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P31-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P31R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P31-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P31L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P31-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P32" transform="translate(235,120)">
							<?php
						$P32C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P32-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P32T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P32-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P32B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P32-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P32R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P32-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P32L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P32-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P33" transform="translate(260,120)">
							<?php
						$P33C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P33-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P33T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P33-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P33B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P33-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P33R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P33-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P33L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P33-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P34" transform="translate(285,120)">
							<?php
						$P34C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P34-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P34T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P34-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P34B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P34-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P34R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P34-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P34L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P34-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P35" transform="translate(310,120)">
							<?php
						$P35C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P35-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P35T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P35-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P35B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P35-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P35R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P35-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P35L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P35-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P36" transform="translate(335,120)">
							<?php
						$P36C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P36-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P36T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P36-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P36B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P36-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P36R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P36-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P36L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P36-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P37" transform="translate(360,120)">
							<?php
						$P37C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P37-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P37T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P37-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P37B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P37-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P37R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P37-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P37L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P37-L' ORDER BY id_medical_record DESC") ->row_array();
						...
						<g id="P38" transform="translate(385,120)">
							<?php
						$P38C = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P38-C' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P38T = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P38-T' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P38B = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P38-B' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P38R = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P38-R' ORDER BY id_medical_record DESC") ->row_array();
						...
						$P38L = $this->db->query("SELECT id_kategori_warna FROM medical_record WHERE id_pasien='$rekmed' AND id_odontogram='P38-L' ORDER BY id_medical_record DESC") ->row_array();
...
<table style="border-collapse:collapse;font-family: tahoma; font-size:12px" width="100%" align="center" border="1" cellspacing="1" cellpadding="3" >
    ...
    WHERE a.id_pasien='$rekmed'") ->result();
    ...
    ?>
        <tr>
            ...
            <td align='center' style="background-color:<?= $m->nama_kategori_warna ?>; color:white">
