                ...
                <div class="portlet-body">									
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <!-- <input readonly value="<?= data_master("tbl_namapos", array("kodepos" => $data_pas->kodepos))->namapost ?>" id="poli_per" name="poli_per" class="form-control" type="text">
                                <span class="help-block"></span> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input readonly id="jenkel_per" name="jenkel_per" class="form-control" type="text"
