...
<script>
  function save() {
    ...
    if (nadokter != '' || nadokter != null && nik != '' || nik != null && nosip != '' || nosip != null && npwp != '' || npwp != null && hp != '' || hp != null && status != '' || status != null && tglmasuk != '' || tglmasuk != null && alamat != '' || alamat != null && email != '' || email != null) {
      $.ajax({
        url: "<?php echo site_url('master_perawat2/f_add') ?>",
        ...
        success: function(data) {
          if (data.status == 1) {
            ...
            for (i = 1; i < rowCount; i++) {
              var unit = $("#unit" + i).val();
              $.ajax({
                url: "<?= site_url('master_perawat2/fd_add?unit=') ?>" + unit + "&kodokter=" + kodokter,
                type: "POST",
                dataType: "JSON",
              });
            }
            ...
            for (i = 1; i < rowCount; i++) {
              ...
              $.ajax({
                url: "<?= site_url('master_perawat2/fdc_add?lokasi=') ?>" + lokasi + "&kodokter=" + kodokter,
                type: "POST",
                dataType: "JSON",
              });
            }
