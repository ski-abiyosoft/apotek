          ...
          <div class="tabbable tabbable-custom tabbable-full-width">
                ...
                <div class="row">
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <div class="col-md-5">
                        <input type="hidden" name="jenispegawai" id="jenispegawai" class="form-control" value="2">
                        <input type="text" name="jenispegawaix" id="jenispegawaix" class="form-control" placeholder="Perawat" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-7">
            ...
            <div class="row">
              <div class="wells">
                ...
                <div class="btn-group">
                  <a href="<?= site_url('master_perawat2/v_add') ?>" type="button" class="btn green">
                    <i class="fa fa-pencil-square-o"></i> <b>Data Baru </b>
                  </a>
                </div>
                <div class="btn-group">
                  <a class="btn red" href="<?= site_url('master_perawat2') ?>">
...
<script>
  function update() {
    ...
    if (nadokter != '' || nadokter != null && nik != '' || nik != null && nosip != '' || nosip != null && npwp != '' || npwp != null && hp != '' || hp != null && status != '' || status != null && tglmasuk != '' || tglmasuk != null && alamat != '' || alamat != null && email != '' || email != null) {
      swal({
        title: 'UPDATE DATA',
        html: 'Yakin Ingin Update Data Perawat ' + nadokter,
        type: 'question',
        ...
        $.ajax({
          url: "<?php echo site_url('master_perawat2/f_edit/') ?>" + kodokter,
          ...
          success: function(data) {
            if (data.status == 1) {
              ...
              for (i = 1; i < rowCount; i++) {
                var unit = $("#unit" + i).val();
                $.ajax({
                  url: "<?= site_url('master_perawat2/fd_edit?unit=') ?>" + unit + "&kodokter=" + kodokter,
                  type: "POST",
                  dataType: "JSON",
                  // success: function(data) {
                  //   console.log(data)
              ...
              for (i = 1; i < rowCount; i++) {
                ...
                $.ajax({
                  url: "<?= site_url('master_perawat2/fdc_edit?lokasi=') ?>" + lokasi + "&kodokter=" + kodokter,
                  type: "POST",
                  dataType: "JSON",
                  // success: function(data) {
                  //   console.log(data)
              ...
              swal({
                title: "PERAWAT " + nadokter,
                html: "Berhasil diupdate",
                type: "success",
                confirmButtonText: "OK"
              }).then((value) => {
                location.href = "<?= site_url('master_perawat2') ?>";
              });
            } else {
              swal({
                title: "DATA",
