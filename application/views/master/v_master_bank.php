			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <span class="title-unit">
                      ...
                      - 
                      <span class="title-web">Master <small>Bank</small>
					</h3>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('master_bank/ajax_list')?>",
            "type": "POST"
        },
...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('master_bank/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
		    ...
		    $('[name="id"]').val(data.id);
            $('[name="kode"]').val(data.bankcode);
            $('[name="nama"]').val(data.namabank);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('master_bank/ajax_add')?>";
    } else {
        url = "<?php echo site_url('master_bank/ajax_update')?>";
    }
...
function delete_data(id)
{
    if(confirm('Yakin data Bank dengan kode '+id+' ini akan dihapus ?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('master_bank/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nama" placeholder="Nama Bank" class="form-control" maxlength="100" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>						
