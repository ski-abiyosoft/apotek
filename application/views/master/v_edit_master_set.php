          ...
          <div class="tabbable tabbable-custom tabbable-full-width">
            ...
            <div class="row">
              <div class="wells">
                ...
                <div class="btn-group">
                  <a href="<?= site_url('Master_seting_r/v_add'); ?>" type="button" class="btn green"><i class="fa fa-pencil-square-o"></i> <b>Data Baru </b></a>
                </div>
                <div class="btn-group">
  ...
  function save() {
    ...
    if (tindakan != null || tindakan != '' && kodepos != null || kodepos != '' && accountno != null || accountno != '' && no != null || no != '' && nox != null || nox != '') {
      swal({
        ...
        $.ajax({
          url: "<?php echo site_url('Master_seting_r/f_edit/') ?>" + kodetarif + '/?tidakaktif=' + tidakaktif,
          ...
          success: function(data) {
            if (data.status == 1) {
              ...
              for (i = 1; i < rowCount; i++) {
                ...
                $.ajax({
                  url: "<?= site_url('Master_seting_r/fd_add') ?>" + param,
                  type: "POST",
                  dataType: "JSON",
                });
              }
              ...
              for (i = 1; i < rowCount; i++) {
                ...
                $.ajax({
                  url: "<?= site_url('Master_seting_r/fdc_add') ?>" + param,
                  type: "POST",
                  dataType: "JSON",
                });
              }
