...
function edit_data(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('[name="hargabelippn"]').val(data.hargabelippn);
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Satuan2&nbsp;<small
                                            style="color:red">*</small></label>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-2">
                                        <input name="qtysatuan2" placeholder="" class="form-control" maxlength="100"
                                            type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Satuan3&nbsp;<small
                                            style="color:red">*</small></label>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-2">
                                        <input name="qtysatuan3" placeholder="" class="form-control" maxlength="100"
                                            type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Kemasan&nbsp;<small
                                            style="color:red">*</small></label>
                                    <div class="col-md-9">
                                        <input name="kemasan" id="kemasan" placeholder="" class="form-control"
                                            maxlength="100" type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Harga Beli&nbsp;<small
                                            style="color:red">*</small></label>
                                    <div class="col-md-3">
                                        <input name="hargabeli" id="hargabeli" placeholder="" class="form-control"
                                            maxlength="100" type="text">
                                        <span class="help-block"></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Beli+PPN&nbsp;<small
                                            style="color:red">*</small></label>
                                    <div class="col-md-9">
                                        <input name="hargabelippn" id="hargabelippn" placeholder="" class="form-control"
                                            maxlength="100" type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">HPP&nbsp;<small
                                            style="color:red">*</small></label>
                                    <div class="col-md-9">
                                        <input name="hpp" placeholder="" class="form-control" maxlength="100"
                                            type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Minimum Stock&nbsp;<small
                                            style="color:red">*</small></label>
                                    <div class="col-md-9">
                                        <input name="minstock" placeholder="" class="form-control" maxlength="100"
                                            type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Maksimum Stock&nbsp;<small
                                            style="color:red">*</small></label>
                                    <div class="col-md-9">
                                        <input name="maxstock" placeholder="" class="form-control" maxlength="100"
                                            type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="subjenis" id="subjenis" placeholder="" class="form-control"
                                            type="text">
                                    </div>
                                </div>
