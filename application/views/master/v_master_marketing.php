...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('marketing_master/ajax_list')?>",
            "type": "POST"
        },
...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('marketing_master/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
		    ...
		    $('[name="id"]').val(data.id);
            $('[name="kode"]').val(data.kjenis);
            $('[name="nama"]').val(data.jenispromo);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('marketing_master/ajax_add')?>";
    } else {
        url = "<?php echo site_url('marketing_master/ajax_update')?>";
    }
...
function delete_data(id)
{
    if(confirm('Yakin data Poli dengan kode '+id+' ini akan dihapus ?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('marketing_master/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header header-custom">
                ...
                <h3 class="modal-title">Data Marketing</h3>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kode" placeholder="Kode" class="form-control input-small" type="text" readonly value="auto">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nama" placeholder="" class="form-control" maxlength="100" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>						
