    ...
    <div class="portlet">
      ...
      <div class="portlet-body">
        <div class="table-toolbar">
          ...
          <a href="<?= site_url('Master_perawat2/v_add'); ?>" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Data Baru</a>
        </div>
            ...
            <?php foreach ($list as $l) : ?>
              <tr>
                ...
                <td style="text-align: center">
                  <a type="button" title="Ubah" href="<?= site_url('Master_perawat2/v_edit/') . $l->id; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
...
<script>
  ...
  function getcabang() {
    ...
    location.href = '/Master_perawat2/?cabang=' + cabang;
  }

  function hapus(kodokter, nadokter) {
    swal({
      title: 'HAPUS DATA',
      html: "PERAWAT <b>" + nadokter + "</b> ?",
      type: 'question',
      ...
      $.ajax({
        url: "<?= site_url('Master_perawat2/delete/'); ?>" + kodokter,
        type: "POST",
        dataType: "JSON",
