			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <span class="title-unit">
                      ...
                      - 
                      <span class="title-web">Master <small>Penjamin</small>
					</h3>
							...
							<table id="table" class="table table-striped- table-bordered-" cellspacing="0" width="100%">
                               <thead class="breadcrumb header-custom">
                                     <tr>
                                         ...
                                         <th class="title-white" style="text-align: center">Nama Penjamin</th>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('master_penjamin/ajax_list')?>",
            "type": "POST"
        },
...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('master_penjamin/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
		    ...
		    $('[name="id"]').val(data.id);
            $('[name="kode"]').val(data.cust_id);
            $('[name="nama"]').val(data.cust_nama);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('master_penjamin/ajax_add')?>";
    } else {
        url = "<?php echo site_url('master_penjamin/ajax_update')?>";
    }
...
function delete_data(id)
{
    if(confirm('Yakin data Bank dengan kode '+id+' ini akan dihapus ?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('master_penjamin/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header header-custom">
                ...
                <h3 class="modal-title">Data Penjamin</h3>
            </div>
