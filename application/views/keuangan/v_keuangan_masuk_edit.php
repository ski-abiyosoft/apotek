													        ...
													        <div class="col-md-9">
                                                              <select id="kasbank" name="kasbank" class="form-control select2_el_kasbank" data-placeholder="Pilih..." onkeypress="return tabE(this,event)">
                                                                    ...
                                                                    // kasbank=1 and aclevel=4
                                                                        ...
                                                                        foreach($dt as $row){ 
                                                                        $selected = ($row->accountno==$kasbank ? 'selected' : '');
                                                                    ?>
													        ...
													        <div class="col-md-9">
                                                                ...
                                                                <option value="">--- Pilih ---</option>
                                                                    ...
                                                                    // kasbank=1 and aclevel=4
                                                                        ...
                                                                        foreach($dt as $row){ 
                                                                        $selected = ($row->accountno==$pos ? 'selected' : '');
                                                                    ?>
												...
												<div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-9">
														        <input class="form-control" rows="2" id="jumlah" name="jumlah" value="<?php echo $jumlah;?>"  data-type="currency"/>
													        </div>
...
{	          
	...
	if(tanggal=="" || kasbank=="" || pos=="" || keterangan=="" || jumlah ==""){
		...
		if(kasbank == pos){
			...
			$.ajax({				
				url:'<?php echo site_url('keuangan_masuk/penerimaan_simpan/2')?>',				
