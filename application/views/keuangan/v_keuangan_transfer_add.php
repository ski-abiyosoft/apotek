													...
													<div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-6">
																...
																<input id="tglmutasi" name="tglmutasi" class="form-control date-picker input-medium" type="date" value="<?php echo date('Y-m-d');?>"/>
													        </div>
														</div>
													</div>
												</div>
												...
												<div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-9">
																<input class="form-control" type="text" rows="2" id="cekno" name="cekno" onClick="" />
													        </div>
														</div>
													</div>
                                                    ...
                                                    <div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-9">
														        <input class="form-control" rows="2" id="mutasirp" name="mutasirp"  value="" data-type="currency"/>
													        </div>
												...
												<div class="row">
													...
													<div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-9">
														        <input class="form-control" rows="2" id="admrp" name="admrp" data-type="currency"/> <!-- type="number" -->
													        </div>
														</div>
													</div>
                                                    ...
                                                    <div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-9">
														        <!-- <input class="form-control" rows="2" id="acbiaya" name="acbiaya" onClick="formatCurrency(this)"  /> -->
																<select id="acbiaya" name="acbiaya" class="form-control select2_el_akunbiaya" data-placeholder="Pilih..." onkeypress="return tabE(this,event)"></select>
            												</div>
...
{	          
	...
	if(acdari=="" || 
		...
		if(acdari == acke){
			...
			$.ajax({				
				url:'<?php echo site_url('keuangan_transfer/transfer_save/1')?>',				
				...
				success:function(data){        		
					swal({
								...
								"<p>Tanggal :  " + moment(tglmutasi).format('DD/MM/YYYY') + "</p>" +
								"<p><b>Rp " + mutasirp + "</b></p>",
								type: "info",
