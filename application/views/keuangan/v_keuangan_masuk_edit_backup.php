...
?>	
			...
			<div class="row">
				<div class="col-md-12">
					<h3 class="page-title">
					  KAS/BANK<small>Entri Penerimaan Kas/Bank </small>
					</h3>
													...
													<div class="col-md-6">
														<div class="form-group">
													        ...
													        <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="" name="nomorbukti" id="nomorbukti" value="<?php echo $header->notr;?>" onkeypress="return tabE(this,event)" readonly>																																															
                                                         ...
                                                         <div class="form-group">
													        ...
													        <div class="col-md-6">
														       <div class="input-icon">
															    ...
															    <input id="tanggal" name="tanggal" class="form-control date-picker input-medium" type="date" value="<?php echo date('Y-m-d',strtotime($header->tglkas));?>" />
													    	   </div>
													        </div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
													        ...
													        <div class="col-md-6">
														        <input type="text" class="form-control input-medium" placeholder="" name="penerima" id="penerima" value="<?php echo $header->penerima;?>" >
													        </div>
													...
													<tr>
													   <td width="20%">
														   <select name="akun[]" id="akun<?= $no;?>" class="select2_el form-control" style="width:300px" >
															  <option value="<?= $row->accountpos;?>"><?= $row->acname;?></option>
														   </select>
                                                     	</td>
                                                        ...
                                                        <td width="20%" ><input name="jumlah[]" value="<?= $row->nilairp;?>" id="jumlah<?= $no;?>" data-type="currency" type="text" class="form-control rightJustified" size="40%" value="0" onkeyup="total()" data-type="currency" onkeypress="return tabE(this,event);formatCurrency(this)"></td>
