					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
								    <a href="<?php echo base_url()?>inventory_mutasi_gudang/entri" class="btn btn-success">
							...
							<table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">							
                               <thead>
                                     <tr class="page-breadcrumb breadcrumb">
										 ...
										 <th class="title-white" style="text-align: center;width:8%;">Aksi</th>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('inventory_mutasi_gudang/ajax_list/1')?>",
            "type": "POST"
        },
...
function delete_data(id)
{
    if(confirm('Yakin data barang dengan kode '+id+' ini akan dihapus ?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('inventory_mutasi_gudang/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
...
function cetaklap(str) {
  ...
  xhttp.open("GET", "<?php echo base_url(); ?>inventory_mutasi_gudang/cetak/"+str, true);  
  xhttp.send();
}
...
function filterdata()
{
	...
	table.ajax.url("<?php echo base_url('inventory_mutasi_gudang/ajax_list/')?>"+str).load();		
}
