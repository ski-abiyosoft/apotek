													...
													<div class="col-md-6">
                                                         <div class="form-group">	
                                                           <label class="col-md-3 control-label">Harga Modal</label>
													        <div class="col-md-6">
															    <input type="text" name="hargamodal" id="hargamodal" class="form-control rightJustified" readonly>
												...
												<div class="row">
												 <div class="col-md-12">
                    								...
                    								<tbody>
													   ...
													   <?php
													     $customer = $this->db->query("select * from ar_customer order by nama")->result();
														 $idx = 1;
														 foreach($customer as $row){ ?>
														   <tr>	
														   	<td width="5%" ><input  id="kode<?= $idx;?>" name="kode[]" type="text" class="form-control" value="<?= $row->kode;?>" readonly></td> 
															<td width="20%" ><input id="nama<?= $idx;?>"name="nama[]" type="text" class="form-control" value="<?= $row->nama;?>" readonly></td> 
															<td width="5%" ><input  id="margin<?= $idx;?>"  onchange="totalline(<?= $idx;?>)" name="margin[]" type="text" value="0" class="form-control rightJustified"></td> 
															<td width="5%" ><input  id="partisipasi<?= $idx;?>" onchange="totalline(<?= $idx;?>)" name="partisipasi[]" type="text" value="0" class="form-control rightJustified"></td> 
															<td width="10%" ><input id="hargagros<?= $idx;?>" name="hargagros[]" type="text" value="0" class="form-control rightJustified" readonly></td> 
															<td width="5%" ><input  id="diskon<?= $idx;?>" onchange="totalline(<?= $idx;?>)" name="diskon[]" type="text" value="0" class="form-control rightJustified"></td> 
															<td width="10%" ><input id="harganet<?= $idx;?>" name="harganet[]" type="text" value="0" class="form-control rightJustified" readonly></td> 
														   </tr>
														 <?php 
														 $idx++;
														 } 
