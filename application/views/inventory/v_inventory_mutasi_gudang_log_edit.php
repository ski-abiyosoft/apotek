			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?php echo base_url();?>inventory_mutasi_gudang_log">
                               Daftar Mutasi
                              							</a>
							<i class="fa fa-angle-right"></i>
						</li>
							...
							<div class="tab-pane active" id="tab1">		
												...
												<div class="row">												    												
													<div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-4">
														        <input id="tanggal" name="tanggal" class="form-control input-medium" type="date" value="<?php echo date('Y-m-d', strtotime($header->movedate));?>" />
													...
													<div class="col-md-6">
                                                         <div class="form-group">	
                                                           <label class="col-md-3 control-label">Transfer No.</label>
													        <div class="col-md-6">
															     <input type="text" placeholder="Otomatis" name="nomorbukti" class="form-control" value="<?= $header->moveno;?>" readonly>
												...
												<div class="row">												    												
													...
													<div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-6">
															    <input type="text" placeholder="Otomatis" name="nomohon" class="form-control" value="<?= $header->mohonno;?>" readonly>
												...
												<div class="row">
												 <div class="col-md-12">
													...
													<tr>													   
                                                       <td width="30%">
														    <select name="kode[]" id="kode<?= $no;?>" class="select2_el_log_baranggud form-control" onchange="showbarangname(this.value, 1)">															  
															  <?php
																if($row->kodebarang){
                                                        ...
                                                        <td width="10%" ><input name="qty[]"    onchange="totalline(<?= $no;?>)" value="<?= $row->qtymove;?>" id="qty<?= $no;?>" type="text" class="form-control rightJustified"  ></td>
														...
														<td width="10%" ><input name="expire[]"    id="expire<?= $no;?>" type="date" value="<?= date('Y-m-d',strtotime($row->exp_date));?>" class="form-control "  onkeypress="return tabE(this,event)"></td>
...
function tambah(){
	...
	var akun="<select name='kode[]' id=kode"+idrow+" onchange='showbarangname(this.value,"+idrow+")' class='select2_el_log_baranggud form-control' ></select>";
	td1.innerHTML=akun;
...
function showbarangname(str, id) {   
  ...
  var vid = id;
   $.ajax({
        url : "<?php echo base_url();?>inventory_mutasi_gudang_log/getinfobarang/?kode="+str,
        type: "GET",
        dataType: "JSON",
...
{	      
	...
	$.ajax({				
		url:'<?php echo site_url('inventory_mutasi_gudang_log/save/2')?>',				
