    ...
    <link href="<?php echo base_url('assets/bootstrap-datepicker/css/bootstrap-datepicker3.min.css')?>" rel="stylesheet">
			...
			<div class="row">
				<div class="col-md-12">
					<h3 class="page-title">
					  Inventory <small>Data Sub Kategori</small>
					</h3>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('inventory_subkat/ajax_list')?>",
            "type": "POST"
        },
...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('inventory_subkat/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
			...
			$('[name="kode_kateg"]').val(data.kode_kateg);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('inventory_subkat/ajax_add')?>";
    } else {
        url = "<?php echo site_url('inventory_subkat/ajax_update')?>";
    }
...
{
    if(confirm('Yakin data kategori dengan kode '+id+' ini akan dihapus ?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('inventory_subkat/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function cetaklap(str) {
  ...
  xhttp.open("GET", "<?php echo base_url(); ?>inventory_subkat/cetak/"+str, true);  
  xhttp.send();
}
...
<script>
	$(document).ready(function() {
		...
		$("#simkeureport").html('<iframe src="<?php echo base_url();?>inventory_subkat/cetak/'+no_daftar+'" frameborder="no" width="100%" height="420"></iframe>');
		});	
	});
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="kode_kateg" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nama" placeholder="Nama kategori" class="form-control" maxlength="100" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="pic" class="form-control">
									...
									<?php 
									foreach($karyawan->result_array() as $db) {?>
