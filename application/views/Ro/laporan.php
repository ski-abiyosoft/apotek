    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">LAPORAN RADIOLOGI KLINIK</div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <form action="<?php base_url('laporan_radiologi') ?>" method="get">
        ...
        <?php if(isset($omsetRadio)) { ?>
            <div class="col-lg-12 col-12">
                <div class="portlet-body">
                    <div class="col-lg-6">
                        <div class="table-toolbar">
                            <h5 style="display:inline-block;color:green"><b>Omset Radio</b> </h5>
                        </div>
                        <figure class="highcharts-figure">
        ...
        <br>
        <?php if (isset($dataRadio)) { ?>
            <div class="col-lg-12 col-12">
            <div class="divided"></div>
                <div class="portlet-body mt-5">
                    <div class="table-toolbar">
                        <h5 style="display:inline-block;color:green"><b>Laporan Detail Transaksi Radiologi</b> </h5>
                    </div>
                    <div class="row">
                        <div class="input-daterange">
                            <div class="col-md-2">
                                <form action="<?= base_url('laporan_radiologi/exportLab/pdf') ?>" method="get">
                            ...
                            <div class="col-md-2">
                                <form action="<?= base_url('laporan_radiologi/exportLab/excel') ?>" method="get">
                                    <input type="hidden" class="form-control" name="tgl_mulai" value="<?= isset($start) ? str_replace(' 00:00:00', '', $start) : ''?>" placeholder="" format="YYYY-MM-DD" required>
                                    <input type="hidden" class="form-control" name="tgl_akhir" value="<?= isset($end) ? str_replace(' 23:59:59', '', $end) : '' ?>" placeholder="" format="YYYY-MM-DD" required>
                                    <button type="submit" class="btn green" style="margin-right:20px">
                                        <b>Export Excel</b>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="dataTableLab" name="table" cellspacing="0" width="100%">
                        <thead class="breadcrumb">
                            <tr>
                                <th style="text-align: center" class="title-white">No Radiologi</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?= $data->noradio ?></td>
                                    <td><?= date('d-m-Y', strtotime($data->tglradio)) ?></td>
                                    <td><?= $data->rekmed ?></td>
                                    <td><?= $data->namapas ?></td>
                                    <td><?= $data->diagnosa ?></td>
                                    <td><?= $data->nadokter ?></td>
        ...
        <?php if (isset($dataRekap)) { ?>
            ...
            <div class="divided"></div>
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <h5 style="display:inline-block;color:green"><b>Laporan Rekap Transaksi Radiologi</b> </h5>
                    </div>
                    <div class="row">
                        <div class="input-daterange">
                            <div class="col-md-2">
                                <form action="<?= base_url('laporan_radiologi/exportRekap/pdf') ?>" method="get">
                                    <input type="hidden" class="form-control" name="tgl_mulai" value="<?= isset($start) ? str_replace(' 00:00:00', '', $start) : ''?>" placeholder="" format="YYYY-MM-DD" required>
                                    <input type="hidden" class="form-control" name="tgl_akhir" value="<?= isset($end) ? str_replace(' 23:59:59', '', $end) : '' ?>" placeholder="" format="YYYY-MM-DD" required>
                                    <button type="submit" class="btn green" style="margin-right:20px">
                                        <b>Export PDF</b>
                            ...
                            <div class="col-md-2">
                                <form action="<?= base_url('laporan_radiologi/exportRekap/excel') ?>" method="get">
                                    <input type="hidden" class="form-control" name="tgl_mulai" value="<?= isset($start) ? str_replace(' 00:00:00', '', $start) : ''?>" placeholder="" format="YYYY-MM-DD" required>
                                    <input type="hidden" class="form-control" name="tgl_akhir" value="<?= isset($end) ? str_replace(' 23:59:59', '', $end) : '' ?>" placeholder="" format="YYYY-MM-DD" required>
                                    <button type="submit" class="btn green" style="margin-right:20px">
                                        <b>Export Excel</b>
...
<script>
    ...
    series: [{
        ...
        colorByPoint: true,
        data: [
            <?php foreach ($omsetRadio as $i => $data) { ?>
                <?php 
                    if ($data->jpas == 1) {
                        $name = 'Pasien RS';
                    } else if ($data->jpas == 2) {
                    ...
                    $total_biaya = intval($omsetRadio[0]->total_biaya_pasien) + intval($omsetRadio[0]->total_biaya_pasien); 
