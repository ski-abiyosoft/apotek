                                    ...
                                    <div class="portlet ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="label label-info"><b>KWITANSI</b></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="portlet ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-reorder"></i>
                                                <span class="label label-danger"><b>PENGURANGAN</b></span>
                                            </div>
                                ...
                                <div class="col-md-12" id="histori_form">
                                    <div class="portlet ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-reorder"></i>
                                                <span class="label label-success"><b>HISTORIES UANG MUKA</b></span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                            <div class="form-body">
