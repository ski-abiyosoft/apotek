							...
							<table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                               <thead class="breadcrumb">
                                     <tr>
                                         ...
                                         <th class="title-white" style="text-align: center">User</th>
                                         ...
                                         <th class="title-white" style="text-align: center">Tgl. Masuk</th>
										 <th class="title-white" style="text-align: center">Jam</th>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('pendaftaran/ajax_list/1')?>",
            "type": "POST"
        },
...
function filterdata(){	
	...
	table.ajax.url("<?php echo base_url('pendaftaran/ajax_list/')?>"+str).load();		 
}
...
function Batalkan(id) {		
	swal({
		...
		$.ajax({
			...
			dataType : "json",
			data : {alasan : alasan},
			url : '<?php echo base_url()?>pendaftaran/pembatalan/'+id,
...
function send_wa(id, hp){	 
  swal({
		...
		$.ajax({
			...
			dataType : "json",
			data : {id : id},
			url : '<?php echo base_url()?>pendaftaran/send_wa',
			success:function(response){
				if(response.status == 1) {
					swal(
						'Sending!',
