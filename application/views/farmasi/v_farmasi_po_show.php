                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select id="gudang" name="gudang"
                                                ...
                                                onkeypress="return tabE(this,event)" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input id="tanggal" name="tanggal" class="form-control input-medium"
                                                type="date"
                                                value="<?php echo date('Y-m-d', strtotime($header->tglpo));?>" readonly/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="tanggalkirim" name="tanggalkirim"
                                                ...
                                                value="<?php echo date('Y-m-d', strtotime($header->tglkirim));?>" readonly/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="dikirimvia" id="dikirimvia" value="<?= $header->dikirimvia;?>"
                                                ...
                                                <option <?=$header->dikirimvia =='Call' ? 'selected' : ''?>
                                                    value="Call">
                                                    Call</option>
                                                <option <?=$header->dikirimvia == 'Reff PBF' ? 'selected' : ''?>
                                                ...
                                                <option <?=$header->dikirimvia == 'SMS' ? 'selected' : ''?> value="SMS">
                                                    SMS</option>
                                                <option <?=$header->dikirimvia == 'Email' ? 'selected' : ''?>
                                                    value="Email">
                                                    Email</option>
                                            </select>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-9">
                            <div class="wells">
                                ...
                                <div class="btn-group">
                                    <a class="btn red" href="<?php echo base_url('farmasi_po')?>"><i
...
function tambah() {
    ...
    td0.innerHTML = "<select name='kode[]' id=kode" + idrow +
        "  class='select2_el_farmasi_baranggud form-control input-largex' onchange='showbarangname(this.value, " +
        idrow + ")'></select>";
...
function save() {
    ...
    if (nomor == "" || total == "0.00" || total == "") {
        ...
        $.ajax({
            url: "<?php echo site_url('farmasi_po/ajax_add/2')?>",
