                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <select name="kode[]" id="kode1" class="select2_el_farmasi_barangdata form-control input-largex" onchange="showbarangname(this.value, 1)"></select>
                                                </td>
                                                ...
                                                <td>
                                                    <input name="harga[]" onchange="totalline(1);total();changeharga(1)" value="0" id="harga1" type="text" class="form-control rightJustified">
                                                </td>
                                                <!-- <td  >
...
<script type="text/javascript">
    ...
    function tambah() {
        ...
        td5.innerHTML = "<input name='harga[]' id=harga" + idrow + " onchange='totalline(" + idrow + ");changeharga("+idrow+")' value='0'  type='text' class='form-control rightJustified'>";
    ...
    function changeharga(id) {
        ...
        totalline(id);
        $("#harga" + id).val(formatCurrency(harga));
    }
