        ...
        <div class="tabbable tabbable-custom tabbable-full-width">
              ...
              <div class="row">
                ...
                <div class="col-md-7">
                  <div class="form-group">
                    ...
                    <div class="col-md-1">
                      <input type="checkbox" value="1" name="cekpo" id="cekpo" checked="checked" class="form-control"
                        onchange="cekpo2();">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      ...
                      <input id="tanggaltukar" name="tanggaltukar" class="form-control input-medium" type="date"
              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <input id="diskonrp" name="diskonrp" data-type="currency" class="form-control" type="text"
                        value="0" />
                    </div>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="kemasan" id="kemasan" data-type="currency" class="form-control"
                        value="0">
                    </div>
                ...
                <div class="col-md-12">
                  ...
                  <table id="datatable"
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <button type='button' onclick="hapusBarisIni(1)" class='btn red'><i class='fa fa-trash-o'></i>
                            - 1</button>
                        </td>
                        <td>
                        ...
                        <td>
                          <input name="qty[]" onchange="totalline(1);total();changeqty(1)" value="1" id="qty1"
                        ...
                        <td>
                          <input name="disc[]" onchange="totalline(1);total();changedisc(1)" value="0" id="disc1"
                            type="text" class="form-control rightJustified">
                        </td>
                        <td>
                          <input name="discrp[]" onchange="totalline(1);total();changediscrp(1)" value="0" id="discrp1"
                            type="text" class="form-control rightJustified ">
                        </td>
                        <td>
                          <?php if($pkp == 1) : ?>
          ...
          <div class="row">
            <div class="wells">
              ...
              <button type="button" onclick="savex()" style="margin-left:15px;" id="btnsave" class="btn blue"><i
                  class="fa fa-save"></i>
                <b>Simpan </b></button>
        ...
        $.ajax({
          ...
          success: function(data) {
            if (data.status == '1') {
              ...
              $.ajax({
                url: '<?= site_url() ?>farmasi_bapb/save_one_u/?totvatrp=' + totvatrp +
                  '&totaltagihan=' + Number(parseInt(total.replaceAll(',', ''))) + '&ppnrp=' + Number(
                    parseInt(ppn_123.replaceAll(',', ''))) + '&diskontotal=' + diskontotal,
                data: $('#frmpembelian').serialize(),
                type: 'POST',
                dataType: 'JSON',
              });
