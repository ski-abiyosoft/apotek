...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url();?>farmasi_produksi">
                    Daftar Produksi
                </a>
                <i class="fa fa-angle-right"></i>
            </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <!-- <select id="kodebarang" name="kodebarang" class="form-control select2_el_farmasi_barang" data-placeholder="Pilih..." onkeypress="return tabE(this,event)">
            												     <?php
...
function total() {
    ...
    var hnappn = eval(thpp) + (eval(thpp) * 0.11);
