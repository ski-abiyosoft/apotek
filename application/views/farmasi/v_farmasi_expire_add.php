                                    ...
                                    <table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
                                        <thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td width="30%">
                                                        <!-- <select name="kode[]" id="kode1" class="select2_el_farmasi_barang form-control" onchange="showbarangname(this.value, 1)"> -->
                                                        <select name="kode[]" id="kode1" class="select2_el_farmasi_baranggud form-control" onchange="showbarangname(this.value, 1)">
                                                    ...
                                                    <td width="10%"><input name="harga[]" onchange="totalline(1)" id="harga1" type="text" class="form-control rightJustified" onkeypress="return tabE(this,event)"></td>
                                                    <td width="15%"><input name="total[]" onchange="totalline(1)" id="total1" type="text" class="form-control rightJustified" onkeypress="return tabE(this,event)"></td>
                                                    <td width="10%"><input name="expire[]" id="expire1" type="date" class="form-control " onkeypress="return tabE(this,event)">
                                                    </td>
                                                    <td width="10%"><input name="note[]" id="note1" type="text" class="form-control " onkeypress="return tabE(this,event)">
                                                    </td>
                                                </tr>
...
<script>
    ...
    function save() {
        ...
        if (gudang_asal == "" || total == "" || total == "0.00") {
            ...
            $.ajax({
                url: '<?php echo site_url('farmasi_expire/save/1') ?>',
